...
pub type CS0_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, TCCR0A_SPEC, u8, CS0_A, 3, O>;
...
#[doc = "Field `CTC0` reader - Clear Timer on Compare Match"]
pub type CTC0_R = crate::BitReader<bool>;
#[doc = "Field `CTC0` writer - Clear Timer on Compare Match"]
pub type CTC0_W<'a, const O: u8> = crate::BitWriter<'a, u8, TCCR0A_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 3 - Clear Timer on Compare Match"]
    #[inline(always)]
    pub fn ctc0(&self) -> CTC0_R {
        CTC0_R::new(((self.bits >> 3) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:2 - Clock Select"]
