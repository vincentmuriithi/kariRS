...
pub struct RegisterBlock {
    ...
    pub mcucr: MCUCR,
    #[doc = "0x18 - Configuration Change Protection"]
    pub ccp: CCP,
    ...
    pub prr: PRR,
    _reserved10: [u8; 0x01],
    #[doc = "0x28 - Oscillator Calibration Register 8MHz"]
    pub osccal0: OSCCAL0,
    #[doc = "0x29 - Oscillator Calibration Register 32kHz"]
    pub osccal1: OSCCAL1,
    _reserved12: [u8; 0x88],
    #[doc = "0xb2 - Oscillator Temperature Calibration Register A"]
    pub osctcal0a: OSCTCAL0A,
    #[doc = "0xb3 - Oscillator Temperature Calibration Register B"]
