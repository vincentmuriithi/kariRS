...
pub type RWFLB_R = crate::BitReader<bool>;
#[doc = "Field `RWFLB` writer - Read/Write Fuse and Lock Bits"]
pub type RWFLB_W<'a, const O: u8> = crate::BitWriter<'a, u8, SPMCSR_SPEC, bool, O>;
...
pub type RSIG_R = crate::BitReader<bool>;
#[doc = "Field `RSIG` writer - Read Device Signature Imprint Table"]
pub type RSIG_W<'a, const O: u8> = crate::BitWriter<'a, u8, SPMCSR_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rwflb(&mut self) -> RWFLB_W<3> {
        RWFLB_W::new(self)
    }
    #[doc = "Bit 4 - Read-While-Write section read enable"]
    #[inline(always)]
