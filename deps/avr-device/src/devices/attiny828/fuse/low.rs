...
impl SUT_CKSEL_R {
    ...
    #[doc = "Checks if the value of the field is `INTULPOSC_32KHZ_6CK_14CK_0MS`"]
    #[inline(always)]
    ...
    #[doc = "Checks if the value of the field is `INTULPOSC_32KHZ_6CK_14CK_4MS1`"]
    #[inline(always)]
    ...
    #[doc = "Checks if the value of the field is `INTULPOSC_32KHZ_6CK_14CK_65MS`"]
    #[inline(always)]
...
impl<'a, const O: u8> SUT_CKSEL_W<'a, O> {
    ...
    #[inline(always)]
    pub fn intulposc_32khz_6ck_14ck_0ms(self) -> &'a mut W {
    ...
    #[inline(always)]
    pub fn intulposc_32khz_6ck_14ck_4ms1(self) -> &'a mut W {
    ...
    #[inline(always)]
    pub fn intulposc_32khz_6ck_14ck_65ms(self) -> &'a mut W {
