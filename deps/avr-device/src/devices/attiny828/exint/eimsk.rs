...
#[doc = "Field `INT` reader - External Interrupt Request Enables"]
pub type INT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `INT` writer - External Interrupt Request Enables"]
pub type INT_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, EIMSK_SPEC, u8, u8, 2, O>;
impl R {
    #[doc = "Bits 0:1 - External Interrupt Request Enables"]
    #[inline(always)]
