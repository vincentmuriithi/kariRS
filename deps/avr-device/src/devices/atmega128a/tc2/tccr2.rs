...
#[doc = "Field `CS0` reader - Clock Select 0"]
...
#[doc = "Field `CS0` writer - Clock Select 0"]
pub type CS0_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, TCCR2_SPEC, u8, CS0_A, 3, O>;
...
#[doc = "Field `COM2` reader - Compare Match Output Mode"]
pub type COM2_R = crate::FieldReader<u8, u8>;
#[doc = "Field `COM2` writer - Compare Match Output Mode"]
pub type COM2_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, TCCR2_SPEC, u8, u8, 2, O>;
#[doc = "Field `WGM20` reader - Wafeform Generation Mode"]
pub type WGM20_R = crate::BitReader<WGM20_A>;
#[doc = "Wafeform Generation Mode\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum WGM20_A {
    #[doc = "0: Normal"]
    VAL_0X00 = 0,
...
#[doc = "Field `WGM20` writer - Wafeform Generation Mode"]
...
impl R {
    ...
    #[doc = "Bits 4:5 - Compare Match Output Mode"]
    #[inline(always)]
    pub fn com2(&self) -> COM2_R {
        COM2_R::new((self.bits >> 4) & 3)
    }
    #[doc = "Bit 6 - Wafeform Generation Mode"]
    #[inline(always)]
