...
pub type TICIE1_R = crate::BitReader<bool>;
#[doc = "Field `TICIE1` writer - Timer/Counter1 Input Capture Interrupt Enable"]
pub type TICIE1_W<'a, const O: u8> = crate::BitWriter<'a, u8, TIMSK_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ocie1b(&mut self) -> OCIE1B_W<3> {
        OCIE1B_W::new(self)
    }
    #[doc = "Bit 4 - Timer/Counter1 Output CompareA Match Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ocie1a(&mut self) -> OCIE1A_W<4> {
        OCIE1A_W::new(self)
    }
    #[doc = "Bit 5 - Timer/Counter1 Input Capture Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ticie1(&mut self) -> TICIE1_W<5> {
        TICIE1_W::new(self)
    }
