...
pub type COM0_R = crate::FieldReader<u8, COM0_A>;
...
impl COM0_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<COM0_A> {
        match self.bits {
...
pub type COM0_W<'a, const O: u8> = crate::FieldWriter<'a, u8, TCCR0_SPEC, u8, COM0_A, 2, O>;
impl<'a, const O: u8> COM0_W<'a, O> {
