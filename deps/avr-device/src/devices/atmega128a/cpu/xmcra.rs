...
pub type SRW11_R = crate::BitReader<bool>;
#[doc = "Field `SRW11` writer - Wait state select bit upper page"]
pub type SRW11_W<'a, const O: u8> = crate::BitWriter<'a, u8, XMCRA_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn srw11(&mut self) -> SRW11_W<1> {
        SRW11_W::new(self)
    }
    #[doc = "Bits 2:3 - Wait state select bit lower page"]
    #[inline(always)]
    #[must_use]
    pub fn srw0(&mut self) -> SRW0_W<2> {
        SRW0_W::new(self)
    }
    #[doc = "Bits 4:6 - Wait state page limit"]
    #[inline(always)]
