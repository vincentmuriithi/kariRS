...
pub struct R(crate::R<USIBR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USIBR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USIBR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USIBR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USIBR` writer"]
pub struct W(crate::W<USIBR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USIBR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USIBR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USIBR_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
