...
#[doc = "Field `PSR0` reader - Prescaler Reset Timer/Counter1 and Timer/Counter0"]
pub type PSR0_R = crate::BitReader<bool>;
#[doc = "Field `PSR0` writer - Prescaler Reset Timer/Counter1 and Timer/Counter0"]
