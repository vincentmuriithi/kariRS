...
pub struct R(crate::R<DWDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DWDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DWDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DWDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DWDR` writer"]
pub struct W(crate::W<DWDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DWDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DWDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DWDR_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
