...
pub type UCPOL2_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCSR2C_SPEC, UCPOL2_A, O>;
impl<'a, const O: u8> UCPOL2_W<'a, O> {
...
pub type UCSZ2_R = crate::FieldReader<u8, UCSZ2_A>;
#[doc = "Character Size\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum UCSZ2_A {
...
pub type UCSZ2_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, UCSR2C_SPEC, u8, UCSZ2_A, 2, O>;
...
pub type UPM2_W<'a, const O: u8> = crate::FieldWriter<'a, u8, UCSR2C_SPEC, u8, UPM2_A, 2, O>;
impl<'a, const O: u8> UPM2_W<'a, O> {
    #[doc = "Disabled"]
    #[inline(always)]
...
pub type UMSEL2_R = crate::FieldReader<u8, UMSEL2_A>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ucpol2(&mut self) -> UCPOL2_W<0> {
        UCPOL2_W::new(self)
    }
    #[doc = "Bits 1:2 - Character Size"]
    #[inline(always)]
    #[must_use]
    pub fn ucsz2(&mut self) -> UCSZ2_W<1> {
        UCSZ2_W::new(self)
    }
    #[doc = "Bit 3 - Stop Bit Select"]
    #[inline(always)]
    #[must_use]
    pub fn usbs2(&mut self) -> USBS2_W<3> {
        USBS2_W::new(self)
    }
    #[doc = "Bits 4:5 - Parity Mode Bits"]
    #[inline(always)]
    #[must_use]
    pub fn upm2(&mut self) -> UPM2_W<4> {
        UPM2_W::new(self)
    }
    #[doc = "Bits 6:7 - USART Mode Select"]
    #[inline(always)]
    #[must_use]
    pub fn umsel2(&mut self) -> UMSEL2_W<6> {
        UMSEL2_W::new(self)
    }
