...
pub struct R(crate::R<UDR3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UDR3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UDR3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UDR3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UDR3` writer"]
pub struct W(crate::W<UDR3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UDR3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UDR3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UDR3_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
