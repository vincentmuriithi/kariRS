...
pub struct R(crate::R<UBRR3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UBRR3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UBRR3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UBRR3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UBRR3` writer"]
pub struct W(crate::W<UBRR3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UBRR3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UBRR3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UBRR3_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
