#[doc = "Register `DDRH` reader"]
pub struct R(crate::R<DDRH_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DDRH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DDRH_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DDRH_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DDRH` writer"]
pub struct W(crate::W<DDRH_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DDRH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DDRH_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DDRH_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "PORT H Data Direction Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ddrh](index.html) module"]
pub struct DDRH_SPEC;
impl crate::RegisterSpec for DDRH_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [ddrh::R](R) reader structure"]
impl crate::Readable for DDRH_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ddrh::W](W) writer structure"]
impl crate::Writable for DDRH_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DDRH to value 0"]
impl crate::Resettable for DDRH_SPEC {
