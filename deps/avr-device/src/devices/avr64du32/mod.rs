#![doc = "Peripheral access API for AVR64DU32 microcontrollers (generated using svd2rust v0.28.0 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
unsafe impl Send for BOOTROW {}
impl BOOTROW {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const bootrow::RegisterBlock = 0x1100 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const bootrow::RegisterBlock {
        Self::PTR
    }
}
impl Deref for BOOTROW {
    type Target = bootrow::RegisterBlock;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        unsafe { &*Self::PTR }
    }
}
impl core::fmt::Debug for BOOTROW {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BOOTROW").finish()
    }
}
#[doc = "Boot Row"]
pub mod bootrow;
...
impl SIGROW {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const sigrow::RegisterBlock = 0x1080 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
...
impl USB0 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const usb0::RegisterBlock = 0x0c00 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
...
impl USERROW {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const userrow::RegisterBlock = 0x1200 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
