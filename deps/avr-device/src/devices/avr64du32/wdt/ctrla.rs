...
pub type PERIOD_W<'a, const O: u8> = crate::FieldWriter<'a, u8, CTRLA_SPEC, u8, PERIOD_A, 4, O>;
...
pub type WINDOW_W<'a, const O: u8> = crate::FieldWriter<'a, u8, CTRLA_SPEC, u8, WINDOW_A, 4, O>;
