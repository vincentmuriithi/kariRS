...
pub struct R(crate::R<TRUTH2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TRUTH2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TRUTH2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TRUTH2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TRUTH2` writer"]
pub struct W(crate::W<TRUTH2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TRUTH2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TRUTH2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TRUTH2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TRUTH_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, TRUTH2_SPEC, u8, u8, 8, O>;
impl R {
