#[doc = "Register `LUT3CTRLB` reader"]
pub struct R(crate::R<LUT3CTRLB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LUT3CTRLB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LUT3CTRLB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LUT3CTRLB_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `LUT3CTRLB` writer"]
pub struct W(crate::W<LUT3CTRLB_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LUT3CTRLB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LUT3CTRLB_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LUT3CTRLB_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum INSEL0_A {
    ...
    AC0 = 6,
    #[doc = "7: USART0 TXD input source"]
    USART0 = 7,
    #[doc = "8: SPI0 MOSI input source"]
    SPI0 = 8,
    #[doc = "9: TCA0 WO0 input source"]
    TCA0 = 9,
    #[doc = "10: TCB0 WO input source"]
    TCB0 = 10,
}
...
impl INSEL0_R {
    ...
    pub fn variant(&self) -> Option<INSEL0_A> {
        match self.bits {
            ...
            5 => Some(INSEL0_A::IN0),
            6 => Some(INSEL0_A::AC0),
            7 => Some(INSEL0_A::USART0),
            8 => Some(INSEL0_A::SPI0),
            9 => Some(INSEL0_A::TCA0),
            10 => Some(INSEL0_A::TCB0),
            _ => None,
        }
    }
    ...
    #[doc = "Checks if the value of the field is `IN0`"]
    #[inline(always)]
    pub fn is_in0(&self) -> bool {
        *self == INSEL0_A::IN0
    }
...
pub type INSEL0_W<'a, const O: u8> = crate::FieldWriter<'a, u8, LUT3CTRLB_SPEC, u8, INSEL0_A, 4, O>;
impl<'a, const O: u8> INSEL0_W<'a, O> {
    ...
    #[inline(always)]
    pub fn in0(self) -> &'a mut W {
        self.variant(INSEL0_A::IN0)
    }
...
pub enum INSEL1_A {
    ...
    #[doc = "4: Event input source B"]
    EVENTB = 4,
    #[doc = "5: IO pin LUTn-IN1 input source"]
    IN1 = 5,
    #[doc = "6: AC0 OUT input source"]
    AC0 = 6,
    #[doc = "7: USART1 TXD input source"]
    USART1 = 7,
    #[doc = "8: SPI0 MOSI input source"]
    SPI0 = 8,
    #[doc = "9: TCA0 WO1 input source"]
    TCA0 = 9,
    #[doc = "10: TCB1 WO input source"]
    TCB1 = 10,
}
...
impl INSEL1_R {
    ...
    pub fn variant(&self) -> Option<INSEL1_A> {
        match self.bits {
            ...
            5 => Some(INSEL1_A::IN1),
            6 => Some(INSEL1_A::AC0),
            7 => Some(INSEL1_A::USART1),
            8 => Some(INSEL1_A::SPI0),
            9 => Some(INSEL1_A::TCA0),
            10 => Some(INSEL1_A::TCB1),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `MASK`"]
    ...
    #[doc = "Checks if the value of the field is `IN1`"]
    #[inline(always)]
    pub fn is_in1(&self) -> bool {
        *self == INSEL1_A::IN1
    }
    #[doc = "Checks if the value of the field is `AC0`"]
    #[inline(always)]
...
pub type INSEL1_W<'a, const O: u8> = crate::FieldWriter<'a, u8, LUT3CTRLB_SPEC, u8, INSEL1_A, 4, O>;
impl<'a, const O: u8> INSEL1_W<'a, O> {
    ...
    #[doc = "IO pin LUTn-IN1 input source"]
    #[inline(always)]
    pub fn in1(self) -> &'a mut W {
        self.variant(INSEL1_A::IN1)
    }
    #[doc = "AC0 OUT input source"]
    #[inline(always)]
    pub fn ac0(self) -> &'a mut W {
...
pub struct LUT3CTRLB_SPEC;
impl crate::RegisterSpec for LUT3CTRLB_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [lut3ctrlb::R](R) reader structure"]
impl crate::Readable for LUT3CTRLB_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [lut3ctrlb::W](W) writer structure"]
impl crate::Writable for LUT3CTRLB_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets LUT3CTRLB to value 0"]
impl crate::Resettable for LUT3CTRLB_SPEC {
