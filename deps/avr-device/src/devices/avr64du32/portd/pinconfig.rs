#[doc = "Register `PINCONFIG` reader"]
pub struct R(crate::R<PINCONFIG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PINCONFIG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PINCONFIG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PINCONFIG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PINCONFIG` writer"]
pub struct W(crate::W<PINCONFIG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PINCONFIG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PINCONFIG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PINCONFIG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ISC_W<'a, const O: u8> = crate::FieldWriter<'a, u8, PINCONFIG_SPEC, u8, ISC_A, 3, O>;
...
pub type PULLUPEN_W<'a, const O: u8> = crate::BitWriter<'a, u8, PINCONFIG_SPEC, bool, O>;
...
pub type INLVL_W<'a, const O: u8> = crate::BitWriter<'a, u8, PINCONFIG_SPEC, INLVL_A, O>;
...
pub type INVEN_W<'a, const O: u8> = crate::BitWriter<'a, u8, PINCONFIG_SPEC, bool, O>;
impl R {
...
#[doc = "Pin Control Config\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pinconfig](index.html) module"]
pub struct PINCONFIG_SPEC;
impl crate::RegisterSpec for PINCONFIG_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [pinconfig::R](R) reader structure"]
impl crate::Readable for PINCONFIG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pinconfig::W](W) writer structure"]
impl crate::Writable for PINCONFIG_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets PINCONFIG to value 0"]
impl crate::Resettable for PINCONFIG_SPEC {
