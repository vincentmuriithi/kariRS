#[doc = "Register `USEREVSYSEVOUTA` reader"]
pub struct R(crate::R<USEREVSYSEVOUTA_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USEREVSYSEVOUTA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USEREVSYSEVOUTA_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USEREVSYSEVOUTA_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USEREVSYSEVOUTA` writer"]
pub struct W(crate::W<USEREVSYSEVOUTA_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USEREVSYSEVOUTA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USEREVSYSEVOUTA_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USEREVSYSEVOUTA_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type USER_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, USEREVSYSEVOUTA_SPEC, u8, USER_A, 8, O>;
...
#[doc = "EVOUTA\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [userevsysevouta](index.html) module"]
pub struct USEREVSYSEVOUTA_SPEC;
impl crate::RegisterSpec for USEREVSYSEVOUTA_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [userevsysevouta::R](R) reader structure"]
impl crate::Readable for USEREVSYSEVOUTA_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [userevsysevouta::W](W) writer structure"]
impl crate::Writable for USEREVSYSEVOUTA_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USEREVSYSEVOUTA to value 0"]
impl crate::Resettable for USEREVSYSEVOUTA_SPEC {
