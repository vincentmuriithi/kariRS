#[doc = "Register `USEREVSYSEVOUTF` reader"]
pub struct R(crate::R<USEREVSYSEVOUTF_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USEREVSYSEVOUTF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USEREVSYSEVOUTF_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USEREVSYSEVOUTF_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USEREVSYSEVOUTF` writer"]
pub struct W(crate::W<USEREVSYSEVOUTF_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USEREVSYSEVOUTF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USEREVSYSEVOUTF_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USEREVSYSEVOUTF_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type USER_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, USEREVSYSEVOUTF_SPEC, u8, USER_A, 8, O>;
...
#[doc = "EVOUTF\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [userevsysevoutf](index.html) module"]
pub struct USEREVSYSEVOUTF_SPEC;
impl crate::RegisterSpec for USEREVSYSEVOUTF_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [userevsysevoutf::R](R) reader structure"]
impl crate::Readable for USEREVSYSEVOUTF_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [userevsysevoutf::W](W) writer structure"]
impl crate::Writable for USEREVSYSEVOUTF_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USEREVSYSEVOUTF to value 0"]
impl crate::Resettable for USEREVSYSEVOUTF_SPEC {
