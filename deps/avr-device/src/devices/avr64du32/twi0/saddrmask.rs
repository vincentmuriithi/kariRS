...
#[doc = "Field `ADDREN` reader - Address Mask Enable"]
pub type ADDREN_R = crate::BitReader<bool>;
#[doc = "Field `ADDREN` writer - Address Mask Enable"]
pub type ADDREN_W<'a, const O: u8> = crate::BitWriter<'a, u8, SADDRMASK_SPEC, bool, O>;
#[doc = "Field `ADDRMASK` reader - Address Mask"]
pub type ADDRMASK_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ADDRMASK` writer - Address Mask"]
pub type ADDRMASK_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, SADDRMASK_SPEC, u8, u8, 7, O>;
impl R {
    #[doc = "Bit 0 - Address Mask Enable"]
    #[inline(always)]
