...
#[doc = "Field `USBSINK` reader - USB Voltage Regulator Current Sink Enable"]
pub type USBSINK_R = crate::BitReader<USBSINK_A>;
#[doc = "USB Voltage Regulator Current Sink Enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum USBSINK_A {
    #[doc = "0: USB VREG can not sink current"]
    DISABLE = 0,
    #[doc = "1: USB VREG can sink current"]
    ENABLE = 1,
}
impl From<USBSINK_A> for bool {
    #[inline(always)]
    fn from(variant: USBSINK_A) -> Self {
        variant as u8 != 0
    }
}
impl USBSINK_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> USBSINK_A {
        match self.bits {
            false => USBSINK_A::DISABLE,
            true => USBSINK_A::ENABLE,
        }
    }
    #[doc = "Checks if the value of the field is `DISABLE`"]
    #[inline(always)]
    pub fn is_disable(&self) -> bool {
        *self == USBSINK_A::DISABLE
    }
    #[doc = "Checks if the value of the field is `ENABLE`"]
    #[inline(always)]
    pub fn is_enable(&self) -> bool {
        *self == USBSINK_A::ENABLE
    }
}
#[doc = "Field `USBSINK` writer - USB Voltage Regulator Current Sink Enable"]
pub type USBSINK_W<'a, const O: u8> = crate::BitWriter<'a, u8, SYSCFG1_SPEC, USBSINK_A, O>;
impl<'a, const O: u8> USBSINK_W<'a, O> {
    #[doc = "USB VREG can not sink current"]
    #[inline(always)]
    pub fn disable(self) -> &'a mut W {
        self.variant(USBSINK_A::DISABLE)
    }
    #[doc = "USB VREG can sink current"]
    #[inline(always)]
    pub fn enable(self) -> &'a mut W {
        self.variant(USBSINK_A::ENABLE)
    }
}
impl R {
    ...
    #[doc = "Bit 3 - USB Voltage Regulator Current Sink Enable"]
    #[inline(always)]
    pub fn usbsink(&self) -> USBSINK_R {
        USBSINK_R::new(((self.bits >> 3) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:2 - Startup Time"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn usbsink(&mut self) -> USBSINK_W<3> {
        USBSINK_W::new(self)
    }
