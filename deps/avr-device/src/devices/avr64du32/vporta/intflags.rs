...
#[doc = "Field `INT` reader - Pin Interrupt Flag"]
pub type INT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `INT` writer - Pin Interrupt Flag"]
pub type INT_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, INTFLAGS_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - Pin Interrupt Flag"]
    #[inline(always)]
