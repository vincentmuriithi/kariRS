...
pub struct RegisterBlock {
    ...
    #[doc = "0x16 - PIT Event Generation Control A"]
    pub pitevgenctrla: PITEVGENCTRLA,
}
...
pub mod pitdbgctrl;
#[doc = "PITEVGENCTRLA (rw) register accessor: an alias for `Reg<PITEVGENCTRLA_SPEC>`"]
pub type PITEVGENCTRLA = crate::Reg<pitevgenctrla::PITEVGENCTRLA_SPEC>;
#[doc = "PIT Event Generation Control A"]
pub mod pitevgenctrla;
