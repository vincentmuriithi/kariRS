...
pub struct R(crate::R<SPLIT_HPER_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPLIT_HPER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPLIT_HPER_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPLIT_HPER_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HPER` writer"]
pub struct W(crate::W<SPLIT_HPER_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPLIT_HPER_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPLIT_HPER_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPLIT_HPER_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
