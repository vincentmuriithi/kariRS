...
#[doc = "Field `SSIF` reader - SPI Select Trigger Interrupt Flag"]
pub type SSIF_R = crate::BitReader<bool>;
#[doc = "Field `SSIF` writer - SPI Select Trigger Interrupt Flag"]
...
impl R {
    ...
    #[doc = "Bit 4 - SPI Select Trigger Interrupt Flag"]
    #[inline(always)]
