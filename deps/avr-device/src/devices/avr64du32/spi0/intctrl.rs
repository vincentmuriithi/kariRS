...
#[doc = "Field `SSIE` reader - SPI Select Trigger Interrupt Enable"]
pub type SSIE_R = crate::BitReader<bool>;
#[doc = "Field `SSIE` writer - SPI Select Trigger Interrupt Enable"]
...
impl R {
    ...
    #[doc = "Bit 4 - SPI Select Trigger Interrupt Enable"]
    #[inline(always)]
