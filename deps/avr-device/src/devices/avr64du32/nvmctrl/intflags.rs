...
pub type EEREADY_W<'a, const O: u8> = crate::BitWriter<'a, u8, INTFLAGS_SPEC, bool, O>;
#[doc = "Field `FLREADY` reader - Flash Ready"]
pub type FLREADY_R = crate::BitReader<bool>;
#[doc = "Field `FLREADY` writer - Flash Ready"]
pub type FLREADY_W<'a, const O: u8> = crate::BitWriter<'a, u8, INTFLAGS_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 1 - Flash Ready"]
    #[inline(always)]
    pub fn flready(&self) -> FLREADY_R {
        FLREADY_R::new(((self.bits >> 1) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - EEPROM Ready"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn flready(&mut self) -> FLREADY_W<1> {
        FLREADY_W::new(self)
    }
