...
pub type MUXPOS_R = crate::BitReader<MUXPOS_A>;
...
pub type MUXPOS_W<'a, const O: u8> = crate::BitWriter<'a, u8, MUXCTRLA_SPEC, MUXPOS_A, O>;
...
impl R {
    ...
    #[doc = "Bit 3 - Positive Input MUX Selection"]
    #[inline(always)]
    pub fn muxpos(&self) -> MUXPOS_R {
        MUXPOS_R::new(((self.bits >> 3) & 1) != 0)
    }
