...
pub type TRIGEI_W<'a, const O: u8> = crate::BitWriter<'a, u8, EVCTRLB_SPEC, bool, O>;
...
pub type ACTION_W<'a, const O: u8> = crate::BitWriter<'a, u8, EVCTRLB_SPEC, ACTION_A, O>;
...
pub type EDGE_W<'a, const O: u8> = crate::BitWriter<'a, u8, EVCTRLB_SPEC, EDGE_A, O>;
...
pub type CFG_W<'a, const O: u8> = crate::FieldWriter<'a, u8, EVCTRLB_SPEC, u8, CFG_A, 2, O>;
