...
#[doc = "Field `UCSZ1` reader - Character Size - together with UCSZ12 in UCSR1B"]
pub type UCSZ1_R = crate::FieldReader<u8, UCSZ1_A>;
#[doc = "Character Size - together with UCSZ12 in UCSR1B\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum UCSZ1_A {
...
#[doc = "Field `UCSZ1` writer - Character Size - together with UCSZ12 in UCSR1B"]
...
impl R {
    ...
    #[doc = "Bits 1:2 - Character Size - together with UCSZ12 in UCSR1B"]
    #[inline(always)]
