...
#[doc = "Field `SFDE1` reader - Start frame detection enable"]
pub type SFDE1_R = crate::BitReader<bool>;
#[doc = "Field `SFDE1` writer - Start frame detection enable"]
pub type SFDE1_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCSR1D_SPEC, bool, O>;
#[doc = "Field `RXS1` reader - USART RX Start"]
pub type RXS1_R = crate::BitReader<bool>;
#[doc = "Field `RXS1` writer - USART RX Start"]
