...
pub type XFDIE_R = crate::BitReader<bool>;
#[doc = "Field `XFDIE` writer - Failure Detection Interrupt Enable"]
pub type XFDIE_W<'a, const O: u8> = crate::BitWriter<'a, u8, XFDCSR_SPEC, bool, O>;
#[doc = "Field `XFDIF` reader - Failure Detection Interrupt Flag"]
pub type XFDIF_R = crate::BitReader<bool>;
#[doc = "Field `XFDIF` writer - Failure Detection Interrupt Flag"]
pub type XFDIF_W<'a, const O: u8> = crate::BitWriter<'a, u8, XFDCSR_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfdie(&mut self) -> XFDIE_W<0> {
        XFDIE_W::new(self)
    }
    #[doc = "Bit 1 - Failure Detection Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn xfdif(&mut self) -> XFDIF_W<1> {
        XFDIF_W::new(self)
    }
