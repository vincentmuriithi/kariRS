...
pub type WGM4_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, TCCR4A_SPEC, u8, u8, 2, O>;
#[doc = "Field `COM4B` reader - Compare Output Mode bits"]
...
#[doc = "Field `COM4B` writer - Compare Output Mode bits"]
...
#[doc = "Field `COM4A` reader - Compare Output Mode bits"]
pub use COM4B_R as COM4A_R;
#[doc = "Field `COM4A` writer - Compare Output Mode bits"]
