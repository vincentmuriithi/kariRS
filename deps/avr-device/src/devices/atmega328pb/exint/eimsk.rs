...
#[doc = "Field `INT0` reader - External Interrupt Request Enable"]
pub type INT0_R = crate::BitReader<bool>;
#[doc = "Field `INT0` writer - External Interrupt Request Enable"]
pub type INT0_W<'a, const O: u8> = crate::BitWriter<'a, u8, EIMSK_SPEC, bool, O>;
#[doc = "Field `INT1` reader - External Interrupt Request Enable"]
pub type INT1_R = crate::BitReader<bool>;
#[doc = "Field `INT1` writer - External Interrupt Request Enable"]
pub type INT1_W<'a, const O: u8> = crate::BitWriter<'a, u8, EIMSK_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - External Interrupt Request Enable"]
    #[inline(always)]
    pub fn int0(&self) -> INT0_R {
        INT0_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - External Interrupt Request Enable"]
    #[inline(always)]
