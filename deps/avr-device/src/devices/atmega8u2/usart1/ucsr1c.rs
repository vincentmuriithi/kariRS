...
pub type UPM1_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, UCSR1C_SPEC, u8, UPM1_A, 2, O>;
...
pub type UMSEL1_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u8, UCSR1C_SPEC, u8, UMSEL1_A, 2, O>;
