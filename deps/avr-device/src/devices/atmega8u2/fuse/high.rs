...
impl BOOTSZ_R {
    ...
    #[doc = "Checks if the value of the field is `_2048W_800`"]
    #[inline(always)]
    pub fn is_2048w_800(&self) -> bool {
        *self == BOOTSZ_A::_2048W_800
    }
    #[doc = "Checks if the value of the field is `_1024W_C00`"]
    #[inline(always)]
    pub fn is_1024w_c00(&self) -> bool {
        *self == BOOTSZ_A::_1024W_C00
    }
    #[doc = "Checks if the value of the field is `_512W_E00`"]
    #[inline(always)]
    pub fn is_512w_e00(&self) -> bool {
        *self == BOOTSZ_A::_512W_E00
    }
    #[doc = "Checks if the value of the field is `_256W_F00`"]
    #[inline(always)]
