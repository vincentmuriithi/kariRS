...
#[doc = "Field `OCF1C` reader - Output Compare Flag 1C"]
pub type OCF1C_R = crate::BitReader<bool>;
#[doc = "Field `OCF1C` writer - Output Compare Flag 1C"]
pub type OCF1C_W<'a, const O: u8> = crate::BitWriter<'a, u8, TIFR1_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 3 - Output Compare Flag 1C"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ocf1c(&mut self) -> OCF1C_W<3> {
        OCF1C_W::new(self)
    }
    #[doc = "Bit 5 - Input Capture Flag 1"]
    #[inline(always)]
