...
#[doc = "Field `INT` reader - External Interrupt Request 7 Enable"]
pub type INT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `INT` writer - External Interrupt Request 7 Enable"]
pub type INT_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, EIMSK_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - External Interrupt Request 7 Enable"]
    #[inline(always)]
