...
pub struct R(crate::R<PCMSK3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PCMSK3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PCMSK3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PCMSK3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PCMSK3` writer"]
pub struct W(crate::W<PCMSK3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PCMSK3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PCMSK3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PCMSK3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PCINT_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, PCMSK3_SPEC, u8, u8, 8, O>;
impl R {
