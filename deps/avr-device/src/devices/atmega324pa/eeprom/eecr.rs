...
#[repr(u8)]
pub enum EEPM_A {
    #[doc = "0: Erase and Write in one operation"]
    ERASE_AND_WRITE_IN_ONE_OPERATION = 0,
    #[doc = "1: Erase Only"]
    ERASE_ONLY = 1,
    #[doc = "2: Write Only"]
    WRITE_ONLY = 2,
...
impl EEPM_R {
    ...
    pub fn variant(&self) -> Option<EEPM_A> {
        match self.bits {
            0 => Some(EEPM_A::ERASE_AND_WRITE_IN_ONE_OPERATION),
            1 => Some(EEPM_A::ERASE_ONLY),
            2 => Some(EEPM_A::WRITE_ONLY),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `ERASE_AND_WRITE_IN_ONE_OPERATION`"]
    #[inline(always)]
    pub fn is_erase_and_write_in_one_operation(&self) -> bool {
        *self == EEPM_A::ERASE_AND_WRITE_IN_ONE_OPERATION
    }
...
impl<'a, const O: u8> EEPM_W<'a, O> {
    #[doc = "Erase and Write in one operation"]
    #[inline(always)]
    pub fn erase_and_write_in_one_operation(self) -> &'a mut W {
        self.variant(EEPM_A::ERASE_AND_WRITE_IN_ONE_OPERATION)
    }
    #[doc = "Erase Only"]
    #[inline(always)]
