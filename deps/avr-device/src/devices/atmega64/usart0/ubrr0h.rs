...
pub struct R(crate::R<UBRR0H_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UBRR0H_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UBRR0H_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UBRR0H_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UBRR0H` writer"]
pub struct W(crate::W<UBRR0H_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UBRR0H_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UBRR0H_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UBRR0H_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
