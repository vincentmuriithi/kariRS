...
pub struct R(crate::R<OCR0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OCR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OCR0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OCR0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OCR0` writer"]
pub struct W(crate::W<OCR0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OCR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OCR0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OCR0_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
