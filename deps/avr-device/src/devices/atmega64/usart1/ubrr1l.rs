...
pub struct R(crate::R<UBRR1L_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UBRR1L_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UBRR1L_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UBRR1L_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UBRR1L` writer"]
pub struct W(crate::W<UBRR1L_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UBRR1L_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UBRR1L_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UBRR1L_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
