...
pub type GCE_R = crate::BitReader<bool>;
#[doc = "Field `GCE` writer - General Call Recognition Enable Bit"]
pub type GCE_W<'a, const O: u8> = crate::BitWriter<'a, u8, SADDR_SPEC, bool, O>;
#[doc = "Field `ADDR` reader - Client Address"]
pub type ADDR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ADDR` writer - Client Address"]
pub type ADDR_W<'a, const O: u8> = crate::FieldWriter<'a, u8, SADDR_SPEC, u8, u8, 7, O>;
impl R {
