#[doc = "Register `USERUSART0IRDA` reader"]
pub struct R(crate::R<USERUSART0IRDA_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USERUSART0IRDA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USERUSART0IRDA_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USERUSART0IRDA_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USERUSART0IRDA` writer"]
pub struct W(crate::W<USERUSART0IRDA_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USERUSART0IRDA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USERUSART0IRDA_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USERUSART0IRDA_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type USER_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, USERUSART0IRDA_SPEC, u8, USER_A, 8, O>;
...
#[doc = "USART0\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [userusart0irda](index.html) module"]
pub struct USERUSART0IRDA_SPEC;
impl crate::RegisterSpec for USERUSART0IRDA_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [userusart0irda::R](R) reader structure"]
impl crate::Readable for USERUSART0IRDA_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [userusart0irda::W](W) writer structure"]
impl crate::Writable for USERUSART0IRDA_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USERUSART0IRDA to value 0"]
impl crate::Resettable for USERUSART0IRDA_SPEC {
