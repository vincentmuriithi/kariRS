#[doc = "Register `USERCCLLUT1A` reader"]
pub struct R(crate::R<USERCCLLUT1A_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USERCCLLUT1A_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USERCCLLUT1A_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USERCCLLUT1A_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USERCCLLUT1A` writer"]
pub struct W(crate::W<USERCCLLUT1A_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USERCCLLUT1A_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USERCCLLUT1A_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USERCCLLUT1A_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type USER_W<'a, const O: u8> = crate::FieldWriter<'a, u8, USERCCLLUT1A_SPEC, u8, USER_A, 8, O>;
...
pub struct USERCCLLUT1A_SPEC;
impl crate::RegisterSpec for USERCCLLUT1A_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [userccllut1a::R](R) reader structure"]
impl crate::Readable for USERCCLLUT1A_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [userccllut1a::W](W) writer structure"]
impl crate::Writable for USERCCLLUT1A_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USERCCLLUT1A to value 0"]
impl crate::Resettable for USERCCLLUT1A_SPEC {
