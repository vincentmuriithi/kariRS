#[doc = "Register `USERCCLLUT3B` reader"]
pub struct R(crate::R<USERCCLLUT3B_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USERCCLLUT3B_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USERCCLLUT3B_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USERCCLLUT3B_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USERCCLLUT3B` writer"]
pub struct W(crate::W<USERCCLLUT3B_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USERCCLLUT3B_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USERCCLLUT3B_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USERCCLLUT3B_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type USER_W<'a, const O: u8> = crate::FieldWriter<'a, u8, USERCCLLUT3B_SPEC, u8, USER_A, 8, O>;
...
pub struct USERCCLLUT3B_SPEC;
impl crate::RegisterSpec for USERCCLLUT3B_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [userccllut3b::R](R) reader structure"]
impl crate::Readable for USERCCLLUT3B_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [userccllut3b::W](W) writer structure"]
impl crate::Writable for USERCCLLUT3B_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USERCCLLUT3B to value 0"]
impl crate::Resettable for USERCCLLUT3B_SPEC {
