#[doc = "Register `USEREVSYSEVOUTD` reader"]
pub struct R(crate::R<USEREVSYSEVOUTD_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USEREVSYSEVOUTD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USEREVSYSEVOUTD_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USEREVSYSEVOUTD_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USEREVSYSEVOUTD` writer"]
pub struct W(crate::W<USEREVSYSEVOUTD_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USEREVSYSEVOUTD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USEREVSYSEVOUTD_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USEREVSYSEVOUTD_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type USER_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, USEREVSYSEVOUTD_SPEC, u8, USER_A, 8, O>;
...
#[doc = "EVOUTD\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [userevsysevoutd](index.html) module"]
pub struct USEREVSYSEVOUTD_SPEC;
impl crate::RegisterSpec for USEREVSYSEVOUTD_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [userevsysevoutd::R](R) reader structure"]
impl crate::Readable for USEREVSYSEVOUTD_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [userevsysevoutd::W](W) writer structure"]
impl crate::Writable for USEREVSYSEVOUTD_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USEREVSYSEVOUTD to value 0"]
impl crate::Resettable for USEREVSYSEVOUTD_SPEC {
