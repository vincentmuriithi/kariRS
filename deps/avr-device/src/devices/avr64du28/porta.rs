...
pub struct RegisterBlock {
    ...
    pub pinconfig: PINCONFIG,
    #[doc = "0x0c - Pin Control Update"]
    pub pinctrlupd: PINCTRLUPD,
    #[doc = "0x0d - Pin Control Set"]
    pub pinctrlset: PINCTRLSET,
    #[doc = "0x0e - Pin Control Clear"]
    pub pinctrlclr: PINCTRLCLR,
    _reserved15: [u8; 0x01],
    ...
    #[doc = "0x18 - Event Generation Control A"]
    pub evgenctrla: EVGENCTRLA,
}
...
pub mod dirtgl;
#[doc = "EVGENCTRLA (rw) register accessor: an alias for `Reg<EVGENCTRLA_SPEC>`"]
pub type EVGENCTRLA = crate::Reg<evgenctrla::EVGENCTRLA_SPEC>;
...
#[doc = "Pin 7 Control"]
pub mod pin7ctrl;
#[doc = "PINCONFIG (rw) register accessor: an alias for `Reg<PINCONFIG_SPEC>`"]
pub type PINCONFIG = crate::Reg<pinconfig::PINCONFIG_SPEC>;
#[doc = "Pin Control Config"]
pub mod pinconfig;
#[doc = "PINCTRLCLR (rw) register accessor: an alias for `Reg<PINCTRLCLR_SPEC>`"]
pub type PINCTRLCLR = crate::Reg<pinctrlclr::PINCTRLCLR_SPEC>;
#[doc = "Pin Control Clear"]
pub mod pinctrlclr;
#[doc = "PINCTRLSET (rw) register accessor: an alias for `Reg<PINCTRLSET_SPEC>`"]
pub type PINCTRLSET = crate::Reg<pinctrlset::PINCTRLSET_SPEC>;
#[doc = "Pin Control Set"]
pub mod pinctrlset;
#[doc = "PINCTRLUPD (rw) register accessor: an alias for `Reg<PINCTRLUPD_SPEC>`"]
