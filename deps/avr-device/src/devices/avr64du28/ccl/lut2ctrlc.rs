...
pub struct R(crate::R<LUT2CTRLC_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LUT2CTRLC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LUT2CTRLC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LUT2CTRLC_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `LUT2CTRLC` writer"]
pub struct W(crate::W<LUT2CTRLC_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LUT2CTRLC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LUT2CTRLC_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LUT2CTRLC_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type INSEL2_W<'a, const O: u8> = crate::FieldWriter<'a, u8, LUT2CTRLC_SPEC, u8, INSEL2_A, 4, O>;
