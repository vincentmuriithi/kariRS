...
pub struct R(crate::R<LUT0CTRLC_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LUT0CTRLC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LUT0CTRLC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LUT0CTRLC_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `LUT0CTRLC` writer"]
pub struct W(crate::W<LUT0CTRLC_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LUT0CTRLC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LUT0CTRLC_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LUT0CTRLC_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum INSEL2_A {
    ...
    USART1 = 7,
    #[doc = "8: SPI0 SCK input source"]
    SPI0 = 8,
    #[doc = "9: TCA0 WO2 input source"]
    TCA0 = 9,
...
impl INSEL2_R {
    ...
    pub fn variant(&self) -> Option<INSEL2_A> {
        match self.bits {
            ...
            5 => Some(INSEL2_A::IN2),
            6 => Some(INSEL2_A::AC0),
            7 => Some(INSEL2_A::USART1),
            8 => Some(INSEL2_A::SPI0),
            9 => Some(INSEL2_A::TCA0),
            10 => Some(INSEL2_A::TCB1),
            _ => None,
        }
    }
...
pub type INSEL2_W<'a, const O: u8> = crate::FieldWriter<'a, u8, LUT0CTRLC_SPEC, u8, INSEL2_A, 4, O>;
