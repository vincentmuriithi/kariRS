#[doc = "Register `PIN3CTRL` reader"]
pub struct R(crate::R<PIN3CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIN3CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PIN3CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PIN3CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIN3CTRL` writer"]
pub struct W(crate::W<PIN3CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIN3CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PIN3CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PIN3CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ISC_W<'a, const O: u8> = crate::FieldWriter<'a, u8, PIN3CTRL_SPEC, u8, ISC_A, 3, O>;
...
pub type PULLUPEN_W<'a, const O: u8> = crate::BitWriter<'a, u8, PIN3CTRL_SPEC, bool, O>;
...
pub type INLVL_W<'a, const O: u8> = crate::BitWriter<'a, u8, PIN3CTRL_SPEC, INLVL_A, O>;
...
pub type INVEN_W<'a, const O: u8> = crate::BitWriter<'a, u8, PIN3CTRL_SPEC, bool, O>;
impl R {
...
pub struct PIN3CTRL_SPEC;
impl crate::RegisterSpec for PIN3CTRL_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [pin3ctrl::R](R) reader structure"]
impl crate::Readable for PIN3CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pin3ctrl::W](W) writer structure"]
impl crate::Writable for PIN3CTRL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets PIN3CTRL to value 0"]
impl crate::Resettable for PIN3CTRL_SPEC {
