...
pub struct R(crate::R<PIN0CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIN0CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PIN0CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PIN0CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIN0CTRL` writer"]
pub struct W(crate::W<PIN0CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIN0CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PIN0CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PIN0CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ISC_W<'a, const O: u8> = crate::FieldWriter<'a, u8, PIN0CTRL_SPEC, u8, ISC_A, 3, O>;
...
pub type PULLUPEN_W<'a, const O: u8> = crate::BitWriter<'a, u8, PIN0CTRL_SPEC, bool, O>;
...
pub type INLVL_W<'a, const O: u8> = crate::BitWriter<'a, u8, PIN0CTRL_SPEC, INLVL_A, O>;
...
pub type INVEN_W<'a, const O: u8> = crate::BitWriter<'a, u8, PIN0CTRL_SPEC, bool, O>;
impl R {
