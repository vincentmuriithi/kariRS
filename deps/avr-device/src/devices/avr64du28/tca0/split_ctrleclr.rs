...
pub struct R(crate::R<SPLIT_CTRLECLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPLIT_CTRLECLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPLIT_CTRLECLR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPLIT_CTRLECLR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CTRLECLR` writer"]
pub struct W(crate::W<SPLIT_CTRLECLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPLIT_CTRLECLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPLIT_CTRLECLR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPLIT_CTRLECLR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CMDEN` reader - Command Enable"]
pub type CMDEN_R = crate::FieldReader<u8, CMDEN_A>;
#[doc = "Command Enable\n\nValue on reset: 0"]
...
impl CMDEN_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<CMDEN_A> {
        match self.bits {
            0 => Some(CMDEN_A::NONE),
            3 => Some(CMDEN_A::BOTH),
            _ => None,
...
pub type CMDEN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, SPLIT_CTRLECLR_SPEC, u8, CMDEN_A, 2, O>;
impl<'a, const O: u8> CMDEN_W<'a, O> {
    #[doc = "None"]
    #[inline(always)]
...
pub type CMD_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u8, SPLIT_CTRLECLR_SPEC, u8, CMD_A, 2, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmden(&mut self) -> CMDEN_W<0> {
        CMDEN_W::new(self)
    }
    #[doc = "Bits 2:3 - Command"]
    #[inline(always)]
