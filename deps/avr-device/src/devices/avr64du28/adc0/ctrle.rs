...
#[doc = "Field `SAMPDUR` reader - Sample Duration"]
pub type SAMPDUR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SAMPDUR` writer - Sample Duration"]
pub type SAMPDUR_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, CTRLE_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - Sample Duration"]
    #[inline(always)]
    pub fn sampdur(&self) -> SAMPDUR_R {
        SAMPDUR_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:7 - Sample Duration"]
    #[inline(always)]
    #[must_use]
    pub fn sampdur(&mut self) -> SAMPDUR_W<0> {
        SAMPDUR_W::new(self)
    }
