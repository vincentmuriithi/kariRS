...
#[doc = "Field `WINLT` reader - Window Low Threshold"]
pub type WINLT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `WINLT` writer - Window Low Threshold"]
pub type WINLT_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u16, WINLT_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - Window Low Threshold"]
    #[inline(always)]
