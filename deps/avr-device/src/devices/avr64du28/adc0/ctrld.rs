...
pub type WINCM_W<'a, const O: u8> = crate::FieldWriter<'a, u8, CTRLD_SPEC, u8, WINCM_A, 3, O>;
...
#[doc = "Field `WINSRC` reader - Window Mode Source"]
pub type WINSRC_R = crate::BitReader<bool>;
#[doc = "Field `WINSRC` writer - Window Mode Source"]
pub type WINSRC_W<'a, const O: u8> = crate::BitWriter<'a, u8, CTRLD_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 3 - Window Mode Source"]
    #[inline(always)]
    pub fn winsrc(&self) -> WINSRC_R {
        WINSRC_R::new(((self.bits >> 3) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:2 - Window Comparator Mode"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn winsrc(&mut self) -> WINSRC_W<3> {
        WINSRC_W::new(self)
    }
