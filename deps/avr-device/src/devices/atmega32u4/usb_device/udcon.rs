...
#[doc = "Field `LSM` reader - USB low speed mode"]
pub type LSM_R = crate::BitReader<bool>;
#[doc = "Field `LSM` writer - USB low speed mode"]
pub type LSM_W<'a, const O: u8> = crate::BitWriter<'a, u8, UDCON_SPEC, bool, O>;
#[doc = "Field `RSTCPU` reader - No Description."]
pub type RSTCPU_R = crate::BitReader<bool>;
#[doc = "Field `RSTCPU` writer - No Description."]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rstcpu(&mut self) -> RSTCPU_W<3> {
        RSTCPU_W::new(self)
    }
