...
pub type ADTS_W<'a, const O: u8> = crate::FieldWriter<'a, u8, ADCSRB_SPEC, u8, ADTS_A, 5, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mux5(&mut self) -> MUX5_W<5> {
        MUX5_W::new(self)
    }
    #[doc = "Bit 7 - ADC High Speed Mode"]
    #[inline(always)]
    #[must_use]
    pub fn adhsm(&mut self) -> ADHSM_W<7> {
        ADHSM_W::new(self)
    }
