#![doc = "Peripheral access API for ATMEGA32U4 microcontrollers (generated using svd2rust v0.28.0 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl USB_DEVICE {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const usb_device::RegisterBlock = 0xd7 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
