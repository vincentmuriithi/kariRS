...
pub type PWM4B_W<'a, const O: u8> = crate::BitWriter<'a, u8, TCCR4A_SPEC, bool, O>;
#[doc = "Field `PWM4A` reader - No Description."]
pub type PWM4A_R = crate::BitReader<bool>;
#[doc = "Field `PWM4A` writer - No Description."]
pub type PWM4A_W<'a, const O: u8> = crate::BitWriter<'a, u8, TCCR4A_SPEC, bool, O>;
#[doc = "Field `FOC4B` writer - Force Output Compare Match 4B"]
pub type FOC4B_W<'a, const O: u8> = crate::BitWriter<'a, u8, TCCR4A_SPEC, bool, O>;
#[doc = "Field `FOC4A` writer - Force Output Compare Match 4A"]
pub type FOC4A_W<'a, const O: u8> = crate::BitWriter<'a, u8, TCCR4A_SPEC, bool, O>;
...
pub type COM4B_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, TCCR4A_SPEC, u8, COM4B_A, 2, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwm4b(&mut self) -> PWM4B_W<0> {
        PWM4B_W::new(self)
    }
    #[doc = "Bit 1 - No Description."]
    #[inline(always)]
    #[must_use]
    pub fn pwm4a(&mut self) -> PWM4A_W<1> {
        PWM4A_W::new(self)
    }
    #[doc = "Bit 2 - Force Output Compare Match 4B"]
    #[inline(always)]
    #[must_use]
    pub fn foc4b(&mut self) -> FOC4B_W<2> {
        FOC4B_W::new(self)
    }
    #[doc = "Bit 3 - Force Output Compare Match 4A"]
    #[inline(always)]
    #[must_use]
    pub fn foc4a(&mut self) -> FOC4A_W<3> {
        FOC4A_W::new(self)
    }
    #[doc = "Bits 4:5 - Compare Output Mode 4B, bits"]
    #[inline(always)]
