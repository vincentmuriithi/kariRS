...
pub type OCF4D_R = crate::BitReader<bool>;
#[doc = "Field `OCF4D` writer - Output Compare Flag 4D"]
pub type OCF4D_W<'a, const O: u8> = crate::BitWriter<'a, u8, TIFR4_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tov4(&mut self) -> TOV4_W<2> {
        TOV4_W::new(self)
    }
    #[doc = "Bit 5 - Output Compare Flag 4B"]
    #[inline(always)]
    #[must_use]
    pub fn ocf4b(&mut self) -> OCF4B_W<5> {
        OCF4B_W::new(self)
    }
    #[doc = "Bit 6 - Output Compare Flag 4A"]
    #[inline(always)]
    #[must_use]
    pub fn ocf4a(&mut self) -> OCF4A_W<6> {
        OCF4A_W::new(self)
    }
    #[doc = "Bit 7 - Output Compare Flag 4D"]
    #[inline(always)]
    #[must_use]
    pub fn ocf4d(&mut self) -> OCF4D_W<7> {
        OCF4D_W::new(self)
    }
