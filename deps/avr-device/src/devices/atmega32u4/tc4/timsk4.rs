...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn toie4(&mut self) -> TOIE4_W<2> {
        TOIE4_W::new(self)
    }
    #[doc = "Bit 5 - Timer/Counter4 Output Compare B Match Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ocie4b(&mut self) -> OCIE4B_W<5> {
        OCIE4B_W::new(self)
    }
    #[doc = "Bit 6 - Timer/Counter4 Output Compare A Match Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ocie4a(&mut self) -> OCIE4A_W<6> {
        OCIE4A_W::new(self)
    }
    #[doc = "Bit 7 - Timer/Counter4 Output Compare D Match Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ocie4d(&mut self) -> OCIE4D_W<7> {
        OCIE4D_W::new(self)
    }
