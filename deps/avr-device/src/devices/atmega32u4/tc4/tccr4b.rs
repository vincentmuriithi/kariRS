...
pub type CS4_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, TCCR4B_SPEC, u8, CS4_A, 4, O>;
...
pub type DTPS4_R = crate::FieldReader<u8, DTPS4_A>;
...
pub type DTPS4_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, TCCR4B_SPEC, u8, DTPS4_A, 2, O>;
impl<'a, const O: u8> DTPS4_W<'a, O> {
    #[doc = "1x (no division)"]
    #[inline(always)]
...
pub type PSR4_R = crate::BitReader<bool>;
#[doc = "Field `PSR4` writer - Prescaler Reset Timer/Counter 4"]
pub type PSR4_W<'a, const O: u8> = crate::BitWriter<'a, u8, TCCR4B_SPEC, bool, O>;
#[doc = "Field `PWM4X` reader - PWM Inversion Mode"]
pub type PWM4X_R = crate::BitReader<bool>;
#[doc = "Field `PWM4X` writer - PWM Inversion Mode"]
pub type PWM4X_W<'a, const O: u8> = crate::BitWriter<'a, u8, TCCR4B_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dtps4(&mut self) -> DTPS4_W<4> {
        DTPS4_W::new(self)
    }
    #[doc = "Bit 6 - Prescaler Reset Timer/Counter 4"]
    #[inline(always)]
    #[must_use]
    pub fn psr4(&mut self) -> PSR4_W<6> {
        PSR4_W::new(self)
    }
    #[doc = "Bit 7 - PWM Inversion Mode"]
    #[inline(always)]
    #[must_use]
    pub fn pwm4x(&mut self) -> PWM4X_W<7> {
        PWM4X_W::new(self)
    }
