...
impl From<crate::R<PLLFRQ_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<PLLFRQ_SPEC>> for W {
    #[inline(always)]
...
pub type PDIV_W<'a, const O: u8> = crate::FieldWriter<'a, u8, PLLFRQ_SPEC, u8, PDIV_A, 4, O>;
...
pub type PLLTM_R = crate::FieldReader<u8, PLLTM_A>;
...
pub type PLLTM_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, PLLFRQ_SPEC, u8, PLLTM_A, 2, O>;
impl<'a, const O: u8> PLLTM_W<'a, O> {
    #[doc = "0 (Disconnected)"]
    #[inline(always)]
...
pub type PLLUSB_R = crate::BitReader<bool>;
#[doc = "Field `PLLUSB` writer - PLL Postscaler for USB Peripheral"]
pub type PLLUSB_W<'a, const O: u8> = crate::BitWriter<'a, u8, PLLFRQ_SPEC, bool, O>;
#[doc = "Field `PINMUX` reader - PLL Input Multiplexer"]
pub type PINMUX_R = crate::BitReader<bool>;
#[doc = "Field `PINMUX` writer - PLL Input Multiplexer"]
pub type PINMUX_W<'a, const O: u8> = crate::BitWriter<'a, u8, PLLFRQ_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn plltm(&mut self) -> PLLTM_W<4> {
        PLLTM_W::new(self)
    }
    #[doc = "Bit 6 - PLL Postscaler for USB Peripheral"]
    #[inline(always)]
    #[must_use]
    pub fn pllusb(&mut self) -> PLLUSB_W<6> {
        PLLUSB_W::new(self)
    }
    #[doc = "Bit 7 - PLL Input Multiplexer"]
    #[inline(always)]
    #[must_use]
    pub fn pinmux(&mut self) -> PINMUX_W<7> {
        PINMUX_W::new(self)
    }
