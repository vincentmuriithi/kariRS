...
pub struct R(crate::R<SINGLE_CTRLECLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SINGLE_CTRLECLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SINGLE_CTRLECLR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SINGLE_CTRLECLR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CTRLECLR` writer"]
pub struct W(crate::W<SINGLE_CTRLECLR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SINGLE_CTRLECLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SINGLE_CTRLECLR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SINGLE_CTRLECLR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DIR_W<'a, const O: u8> = crate::BitWriter<'a, u8, SINGLE_CTRLECLR_SPEC, bool, O>;
#[doc = "Field `LUPD` reader - Lock Update"]
pub type LUPD_R = crate::BitReader<bool>;
#[doc = "Field `LUPD` writer - Lock Update"]
pub type LUPD_W<'a, const O: u8> = crate::BitWriter<'a, u8, SINGLE_CTRLECLR_SPEC, bool, O>;
...
pub type CMD_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u8, SINGLE_CTRLECLR_SPEC, u8, CMD_A, 2, O>;
