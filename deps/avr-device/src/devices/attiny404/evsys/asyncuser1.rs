...
impl ASYNCUSER1_R {
    ...
    pub fn variant(&self) -> Option<ASYNCUSER1_A> {
        match self.bits {
            ...
            2 => Some(ASYNCUSER1_A::SYNCCH1),
            3 => Some(ASYNCUSER1_A::ASYNCCH0),
            4 => Some(ASYNCUSER1_A::ASYNCCH1),
            5 => Some(ASYNCUSER1_A::ASYNCCH2),
            6 => Some(ASYNCUSER1_A::ASYNCCH3),
            _ => None,
        }
    }
...
impl<'a, const O: u8> ASYNCUSER1_W<'a, O> {
    ...
    pub fn syncch1(self) -> &'a mut W {
        self.variant(ASYNCUSER1_A::SYNCCH1)
    }
    ...
    pub fn asyncch2(self) -> &'a mut W {
        self.variant(ASYNCUSER1_A::ASYNCCH2)
    }
    #[doc = "Asynchronous Event Channel 3"]
    #[inline(always)]
    pub fn asyncch3(self) -> &'a mut W {
        self.variant(ASYNCUSER1_A::ASYNCCH3)
    }
}
impl R {
