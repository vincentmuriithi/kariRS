...
pub struct R(crate::R<EIND_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EIND_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EIND_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EIND_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EIND` writer"]
pub struct W(crate::W<EIND_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EIND_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EIND_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EIND_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
