...
impl R {
    ...
    #[doc = "Bit 3 - Output Compare Flag 1B"]
    #[inline(always)]
    pub fn ocf1b(&self) -> OCF1B_R {
        OCF1B_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - Output Compare Flag 1A"]
    #[inline(always)]
    pub fn ocf1a(&self) -> OCF1A_R {
        OCF1A_R::new(((self.bits >> 4) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ocf1b(&mut self) -> OCF1B_W<3> {
        OCF1B_W::new(self)
    }
    #[doc = "Bit 4 - Output Compare Flag 1A"]
    #[inline(always)]
    #[must_use]
    pub fn ocf1a(&mut self) -> OCF1A_W<4> {
        OCF1A_W::new(self)
    }
    #[doc = "Bit 5 - Input Capture Flag 1"]
    #[inline(always)]
