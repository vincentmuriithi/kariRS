...
pub type FAULTDET_R = crate::BitReader<bool>;
#[doc = "Field `FAULTDET` writer - Fault detection"]
pub type FAULTDET_W<'a, const O: u8> = crate::BitWriter<'a, u8, DBGCTRL_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - Debug run"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn faultdet(&mut self) -> FAULTDET_W<2> {
        FAULTDET_W::new(self)
    }
