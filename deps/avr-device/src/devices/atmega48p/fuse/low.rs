...
pub enum SUT_CKSEL_A {
    ...
    #[doc = "34: Int. RC Osc. 8 MHz; Start-up time PWRDWN/RESET: 6 CK/14 CK + 65 ms; default value"]
    INTRCOSC_8MHZ_6CK_14CK_65MS_DEFAULT = 34,
...
impl SUT_CKSEL_R {
    ...
    pub fn variant(&self) -> Option<SUT_CKSEL_A> {
        match self.bits {
            ...
            34 => Some(SUT_CKSEL_A::INTRCOSC_8MHZ_6CK_14CK_65MS_DEFAULT),
