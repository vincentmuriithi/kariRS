...
pub type USITC_R = crate::BitReader<bool>;
...
pub type USICLK_R = crate::BitReader<bool>;
...
pub type USICS_R = crate::FieldReader<u8, u8>;
#[doc = "Field `USICS` writer - USI Clock Source Select Bits"]
pub type USICS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, USICR_SPEC, u8, u8, 2, O>;
...
impl USIWM_R {
    ...
    #[doc = "Checks if the value of the field is `THREE_WIRE_MODE`"]
    #[inline(always)]
    pub fn is_three_wire_mode(&self) -> bool {
        *self == USIWM_A::THREE_WIRE_MODE
    }
    #[doc = "Checks if the value of the field is `TWO_WIRE_MODE`"]
    #[inline(always)]
    pub fn is_two_wire_mode(&self) -> bool {
        *self == USIWM_A::TWO_WIRE_MODE
    }
    #[doc = "Checks if the value of the field is `TWO_WIRE_MODE_HELD_LOW`"]
    #[inline(always)]
...
impl<'a, const O: u8> USIWM_W<'a, O> {
    ...
    #[doc = "Three-Wire Mode"]
    #[inline(always)]
    pub fn three_wire_mode(self) -> &'a mut W {
        self.variant(USIWM_A::THREE_WIRE_MODE)
    }
    #[doc = "Two-Wire Mode"]
    #[inline(always)]
    pub fn two_wire_mode(self) -> &'a mut W {
        self.variant(USIWM_A::TWO_WIRE_MODE)
    }
    #[doc = "Two-Wire Mode Held Low"]
    #[inline(always)]
    pub fn two_wire_mode_held_low(self) -> &'a mut W {
