...
pub type BLB0_R = crate::FieldReader<u8, BLB0_A>;
...
pub type BLB0_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, LOCKBIT_SPEC, u8, BLB0_A, 2, O>;
impl<'a, const O: u8> BLB0_W<'a, O> {
...
pub type BLB1_R = crate::FieldReader<u8, BLB1_A>;
#[doc = "Boot Loader Protection Mode\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum BLB1_A {
...
pub type BLB1_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, LOCKBIT_SPEC, u8, BLB1_A, 2, O>;
impl<'a, const O: u8> BLB1_W<'a, O> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn blb0(&mut self) -> BLB0_W<2> {
        BLB0_W::new(self)
    }
    #[doc = "Bits 4:5 - Boot Loader Protection Mode"]
    #[inline(always)]
    #[must_use]
    pub fn blb1(&mut self) -> BLB1_W<4> {
        BLB1_W::new(self)
    }
