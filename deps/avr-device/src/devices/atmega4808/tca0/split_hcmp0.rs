...
pub struct R(crate::R<SPLIT_HCMP0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPLIT_HCMP0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPLIT_HCMP0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPLIT_HCMP0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HCMP0` writer"]
pub struct W(crate::W<SPLIT_HCMP0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPLIT_HCMP0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPLIT_HCMP0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPLIT_HCMP0_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
