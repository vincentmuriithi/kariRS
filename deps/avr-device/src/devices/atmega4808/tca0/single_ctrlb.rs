...
pub struct R(crate::R<SINGLE_CTRLB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SINGLE_CTRLB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SINGLE_CTRLB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SINGLE_CTRLB_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CTRLB` writer"]
pub struct W(crate::W<SINGLE_CTRLB_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SINGLE_CTRLB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SINGLE_CTRLB_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SINGLE_CTRLB_SPEC>) -> Self {
        W(writer)
    }
}
...
impl WGMODE_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<WGMODE_A> {
        match self.bits {
    ...
    #[doc = "Checks if the value of the field is `SINGLESLOPE`"]
    #[inline(always)]
...
pub type WGMODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, SINGLE_CTRLB_SPEC, u8, WGMODE_A, 3, O>;
impl<'a, const O: u8> WGMODE_W<'a, O> {
    ...
    #[inline(always)]
    pub fn singleslope(self) -> &'a mut W {
...
pub type ALUPD_R = crate::BitReader<bool>;
#[doc = "Field `ALUPD` writer - Auto Lock Update"]
pub type ALUPD_W<'a, const O: u8> = crate::BitWriter<'a, u8, SINGLE_CTRLB_SPEC, bool, O>;
#[doc = "Field `CMP0EN` reader - Compare 0 Enable"]
pub type CMP0EN_R = crate::BitReader<bool>;
#[doc = "Field `CMP0EN` writer - Compare 0 Enable"]
pub type CMP0EN_W<'a, const O: u8> = crate::BitWriter<'a, u8, SINGLE_CTRLB_SPEC, bool, O>;
#[doc = "Field `CMP1EN` reader - Compare 1 Enable"]
pub type CMP1EN_R = crate::BitReader<bool>;
#[doc = "Field `CMP1EN` writer - Compare 1 Enable"]
pub type CMP1EN_W<'a, const O: u8> = crate::BitWriter<'a, u8, SINGLE_CTRLB_SPEC, bool, O>;
#[doc = "Field `CMP2EN` reader - Compare 2 Enable"]
pub type CMP2EN_R = crate::BitReader<bool>;
#[doc = "Field `CMP2EN` writer - Compare 2 Enable"]
pub type CMP2EN_W<'a, const O: u8> = crate::BitWriter<'a, u8, SINGLE_CTRLB_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn alupd(&mut self) -> ALUPD_W<3> {
        ALUPD_W::new(self)
    }
    #[doc = "Bit 4 - Compare 0 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmp0en(&mut self) -> CMP0EN_W<4> {
        CMP0EN_W::new(self)
    }
    #[doc = "Bit 5 - Compare 1 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmp1en(&mut self) -> CMP1EN_W<5> {
        CMP1EN_W::new(self)
    }
    #[doc = "Bit 6 - Compare 2 Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmp2en(&mut self) -> CMP2EN_W<6> {
        CMP2EN_W::new(self)
    }
