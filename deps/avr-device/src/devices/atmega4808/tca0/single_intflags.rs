...
pub struct R(crate::R<SINGLE_INTFLAGS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SINGLE_INTFLAGS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SINGLE_INTFLAGS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SINGLE_INTFLAGS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `INTFLAGS` writer"]
pub struct W(crate::W<SINGLE_INTFLAGS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SINGLE_INTFLAGS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SINGLE_INTFLAGS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SINGLE_INTFLAGS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct SINGLE_INTFLAGS_SPEC;
impl crate::RegisterSpec for SINGLE_INTFLAGS_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [single_intflags::R](R) reader structure"]
impl crate::Readable for SINGLE_INTFLAGS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [single_intflags::W](W) writer structure"]
impl crate::Writable for SINGLE_INTFLAGS_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets INTFLAGS to value 0"]
impl crate::Resettable for SINGLE_INTFLAGS_SPEC {
