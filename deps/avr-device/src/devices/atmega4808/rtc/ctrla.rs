...
#[doc = "Field `CORREN` reader - Correction enable"]
pub type CORREN_R = crate::BitReader<bool>;
#[doc = "Field `CORREN` writer - Correction enable"]
pub type CORREN_W<'a, const O: u8> = crate::BitWriter<'a, u8, CTRLA_SPEC, bool, O>;
