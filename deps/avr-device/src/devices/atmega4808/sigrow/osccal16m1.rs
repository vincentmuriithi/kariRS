...
pub struct R(crate::R<OSCCAL16M1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OSCCAL16M1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OSCCAL16M1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OSCCAL16M1_SPEC>) -> Self {
        R(reader)
    }
}
