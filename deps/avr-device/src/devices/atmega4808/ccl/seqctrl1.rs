...
pub type SEQSEL1_R = crate::FieldReader<u8, SEQSEL1_A>;
...
pub type SEQSEL1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, SEQCTRL1_SPEC, u8, SEQSEL1_A, 3, O>;
impl<'a, const O: u8> SEQSEL1_W<'a, O> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn seqsel1(&mut self) -> SEQSEL1_W<0> {
        SEQSEL1_W::new(self)
    }
