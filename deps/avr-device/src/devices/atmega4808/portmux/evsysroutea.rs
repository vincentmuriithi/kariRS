...
impl EVOUTC_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<EVOUTC_A> {
        match self.bits {
...
pub type EVOUTC_W<'a, const O: u8> = crate::BitWriter<'a, u8, EVSYSROUTEA_SPEC, EVOUTC_A, O>;
impl<'a, const O: u8> EVOUTC_W<'a, O> {
    #[doc = "EVOUT on PC2"]
    #[inline(always)]
    pub fn default(self) -> &'a mut W {
...
impl EVOUTF_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<EVOUTF_A> {
        match self.bits {
            false => Some(EVOUTF_A::DEFAULT),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `DEFAULT`"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn evoutc(&mut self) -> EVOUTC_W<2> {
        EVOUTC_W::new(self)
    }
    #[doc = "Bit 3 - Event Output D"]
    #[inline(always)]
