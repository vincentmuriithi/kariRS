...
#[repr(u8)]
pub enum TWI0_A {
    #[doc = "0: SCL/SDA on PA\\[3:2\\], Client mode on PC\\[3:2\\]
in dual TWI mode"]
    DEFAULT = 0,
    #[doc = "1: SCL/SDA on PA\\[3:2\\], Client mode on PF\\[3:2\\]
in dual TWI mode"]
    ALT1 = 1,
    #[doc = "2: SCL/SDA on PC\\[3:2\\], Client mode on PF\\[3:2\\]
in dual TWI mode"]
    ALT2 = 2,
    #[doc = "3: Not connected to any pins"]
    NONE = 3,
...
impl<'a, const O: u8> TWI0_W<'a, O> {
    #[doc = "SCL/SDA on PA\\[3:2\\], Client mode on PC\\[3:2\\]
in dual TWI mode"]
    #[inline(always)]
    pub fn default(self) -> &'a mut W {
        self.variant(TWI0_A::DEFAULT)
    }
    #[doc = "SCL/SDA on PA\\[3:2\\], Client mode on PF\\[3:2\\]
in dual TWI mode"]
    #[inline(always)]
    pub fn alt1(self) -> &'a mut W {
        self.variant(TWI0_A::ALT1)
    }
    #[doc = "SCL/SDA on PC\\[3:2\\], Client mode on PF\\[3:2\\]
in dual TWI mode"]
    #[inline(always)]
    pub fn alt2(self) -> &'a mut W {
