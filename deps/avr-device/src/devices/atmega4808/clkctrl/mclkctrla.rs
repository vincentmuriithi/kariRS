...
#[repr(u8)]
pub enum CLKSEL_A {
    #[doc = "0: 16/20MHz internal oscillator"]
    OSC20M = 0,
    #[doc = "1: 32.768kHz internal ultra low-power oscillator"]
    OSCULP32K = 1,
...
impl<'a, const O: u8> CLKSEL_W<'a, O> {
    #[doc = "16/20MHz internal oscillator"]
    #[inline(always)]
    pub fn osc20m(self) -> &'a mut W {
        self.variant(CLKSEL_A::OSC20M)
    }
    #[doc = "32.768kHz internal ultra low-power oscillator"]
    #[inline(always)]
