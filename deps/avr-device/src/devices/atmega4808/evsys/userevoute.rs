#[doc = "Register `USEREVOUTE` reader"]
pub struct R(crate::R<USEREVOUTE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USEREVOUTE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USEREVOUTE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USEREVOUTE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USEREVOUTE` writer"]
pub struct W(crate::W<USEREVOUTE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USEREVOUTE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USEREVOUTE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USEREVOUTE_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHANNEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, USEREVOUTE_SPEC, u8, CHANNEL_A, 8, O>;
...
pub struct USEREVOUTE_SPEC;
impl crate::RegisterSpec for USEREVOUTE_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [userevoute::R](R) reader structure"]
impl crate::Readable for USEREVOUTE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [userevoute::W](W) writer structure"]
impl crate::Writable for USEREVOUTE_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USEREVOUTE to value 0"]
impl crate::Resettable for USEREVOUTE_SPEC {
