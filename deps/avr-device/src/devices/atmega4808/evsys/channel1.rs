...
pub struct R(crate::R<CHANNEL1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CHANNEL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CHANNEL1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CHANNEL1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CHANNEL1` writer"]
pub struct W(crate::W<CHANNEL1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CHANNEL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CHANNEL1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CHANNEL1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type GENERATOR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, CHANNEL1_SPEC, u8, GENERATOR_A, 8, O>;
...
pub struct CHANNEL1_SPEC;
impl crate::RegisterSpec for CHANNEL1_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [channel1::R](R) reader structure"]
impl crate::Readable for CHANNEL1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [channel1::W](W) writer structure"]
impl crate::Writable for CHANNEL1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CHANNEL1 to value 0"]
impl crate::Resettable for CHANNEL1_SPEC {
