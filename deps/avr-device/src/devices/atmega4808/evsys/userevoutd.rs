#[doc = "Register `USEREVOUTD` reader"]
pub struct R(crate::R<USEREVOUTD_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USEREVOUTD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USEREVOUTD_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USEREVOUTD_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USEREVOUTD` writer"]
pub struct W(crate::W<USEREVOUTD_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USEREVOUTD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USEREVOUTD_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USEREVOUTD_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHANNEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, USEREVOUTD_SPEC, u8, CHANNEL_A, 8, O>;
...
pub struct USEREVOUTD_SPEC;
impl crate::RegisterSpec for USEREVOUTD_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [userevoutd::R](R) reader structure"]
impl crate::Readable for USEREVOUTD_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [userevoutd::W](W) writer structure"]
impl crate::Writable for USEREVOUTD_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USEREVOUTD to value 0"]
impl crate::Resettable for USEREVOUTD_SPEC {
