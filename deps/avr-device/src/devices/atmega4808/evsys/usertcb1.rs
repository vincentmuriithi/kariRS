#[doc = "Register `USERTCB1` reader"]
pub struct R(crate::R<USERTCB1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USERTCB1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USERTCB1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USERTCB1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USERTCB1` writer"]
pub struct W(crate::W<USERTCB1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USERTCB1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USERTCB1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USERTCB1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHANNEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, USERTCB1_SPEC, u8, CHANNEL_A, 8, O>;
...
pub struct USERTCB1_SPEC;
impl crate::RegisterSpec for USERTCB1_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [usertcb1::R](R) reader structure"]
impl crate::Readable for USERTCB1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [usertcb1::W](W) writer structure"]
impl crate::Writable for USERTCB1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USERTCB1 to value 0"]
impl crate::Resettable for USERTCB1_SPEC {
