...
#[doc = "Field `SAMPLEN` reader - Sample length"]
pub type SAMPLEN_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SAMPLEN` writer - Sample length"]
pub type SAMPLEN_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, SAMPCTRL_SPEC, u8, u8, 5, O>;
impl R {
    #[doc = "Bits 0:4 - Sample length"]
    #[inline(always)]
