...
pub struct R(crate::R<ASYNCCH2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ASYNCCH2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ASYNCCH2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ASYNCCH2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ASYNCCH2` writer"]
pub struct W(crate::W<ASYNCCH2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ASYNCCH2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ASYNCCH2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ASYNCCH2_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `ASYNCCH2` reader - Asynchronous Channel 2 Generator Selection"]
pub type ASYNCCH2_R = crate::FieldReader<u8, ASYNCCH2_A>;
...
pub enum ASYNCCH2_A {
    ...
    PORTC_PIN5 = 15,
    #[doc = "16: Analog Comparator 1 out"]
    AC1_OUT = 16,
    #[doc = "17: Analog Comparator 2 out"]
    AC2_OUT = 17,
}
...
impl ASYNCCH2_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<ASYNCCH2_A> {
        match self.bits {
            ...
            16 => Some(ASYNCCH2_A::AC1_OUT),
            17 => Some(ASYNCCH2_A::AC2_OUT),
            _ => None,
        }
    }
    ...
    pub fn is_ac1_out(&self) -> bool {
        *self == ASYNCCH2_A::AC1_OUT
    }
    #[doc = "Checks if the value of the field is `AC2_OUT`"]
    #[inline(always)]
    pub fn is_ac2_out(&self) -> bool {
        *self == ASYNCCH2_A::AC2_OUT
    }
}
#[doc = "Field `ASYNCCH2` writer - Asynchronous Channel 2 Generator Selection"]
pub type ASYNCCH2_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, ASYNCCH2_SPEC, u8, ASYNCCH2_A, 8, O>;
impl<'a, const O: u8> ASYNCCH2_W<'a, O> {
    #[doc = "Off"]
    #[inline(always)]
    ...
    pub fn ac1_out(self) -> &'a mut W {
        self.variant(ASYNCCH2_A::AC1_OUT)
    }
    #[doc = "Analog Comparator 2 out"]
    #[inline(always)]
    pub fn ac2_out(self) -> &'a mut W {
        self.variant(ASYNCCH2_A::AC2_OUT)
    }
}
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn asyncch2(&mut self) -> ASYNCCH2_W<0> {
        ASYNCCH2_W::new(self)
    }
