...
impl ASYNCCH3_R {
    ...
    pub fn variant(&self) -> Option<ASYNCCH3_A> {
        match self.bits {
            ...
            18 => Some(ASYNCCH3_A::AC1_OUT),
            19 => Some(ASYNCCH3_A::AC2_OUT),
            _ => None,
        }
    }
...
impl<'a, const O: u8> ASYNCCH3_W<'a, O> {
    ...
    pub fn ac1_out(self) -> &'a mut W {
        self.variant(ASYNCCH3_A::AC1_OUT)
    }
    #[doc = "Analog Comparator 2 out"]
    #[inline(always)]
    pub fn ac2_out(self) -> &'a mut W {
        self.variant(ASYNCCH3_A::AC2_OUT)
    }
}
impl R {
