...
pub struct R(crate::R<SYNCCH1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SYNCCH1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SYNCCH1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SYNCCH1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SYNCCH1` writer"]
pub struct W(crate::W<SYNCCH1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SYNCCH1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SYNCCH1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SYNCCH1_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SYNCCH1` reader - Synchronous Channel 1 Generator Selection"]
pub type SYNCCH1_R = crate::FieldReader<u8, SYNCCH1_A>;
...
pub type SYNCCH1_W<'a, const O: u8> = crate::FieldWriter<'a, u8, SYNCCH1_SPEC, u8, SYNCCH1_A, 8, O>;
