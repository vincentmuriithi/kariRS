...
pub struct R(crate::R<ASYNCUSER12_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ASYNCUSER12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ASYNCUSER12_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ASYNCUSER12_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ASYNCUSER12` writer"]
pub struct W(crate::W<ASYNCUSER12_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ASYNCUSER12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ASYNCUSER12_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ASYNCUSER12_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `ASYNCUSER12` reader - Asynchronous User Ch 12 Input Selection - ADC0"]
pub type ASYNCUSER12_R = crate::FieldReader<u8, ASYNCUSER12_A>;
...
impl ASYNCUSER12_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<ASYNCUSER12_A> {
        match self.bits {
...
pub type ASYNCUSER12_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, ASYNCUSER12_SPEC, u8, ASYNCUSER12_A, 8, O>;
impl<'a, const O: u8> ASYNCUSER12_W<'a, O> {
    #[doc = "Off"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn asyncuser12(&mut self) -> ASYNCUSER12_W<0> {
        ASYNCUSER12_W::new(self)
    }
