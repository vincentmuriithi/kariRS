...
pub type DAC1REFSEL_R = crate::FieldReader<u8, DAC1REFSEL_A>;
...
pub type DAC1REFSEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, CTRLC_SPEC, u8, DAC1REFSEL_A, 3, O>;
impl<'a, const O: u8> DAC1REFSEL_W<'a, O> {
...
pub type ADC1REFSEL_R = crate::FieldReader<u8, ADC1REFSEL_A>;
...
pub type ADC1REFSEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, CTRLC_SPEC, u8, ADC1REFSEL_A, 3, O>;
impl<'a, const O: u8> ADC1REFSEL_W<'a, O> {
    #[doc = "Voltage reference at 0.55V"]
    #[inline(always)]
    pub fn _0v55(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dac1refsel(&mut self) -> DAC1REFSEL_W<0> {
        DAC1REFSEL_W::new(self)
    }
    #[doc = "Bits 4:6 - ADC1 reference select"]
    #[inline(always)]
    #[must_use]
    pub fn adc1refsel(&mut self) -> ADC1REFSEL_W<4> {
        ADC1REFSEL_W::new(self)
    }
