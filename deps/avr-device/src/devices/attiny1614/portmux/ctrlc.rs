...
pub type TCA04_W<'a, const O: u8> = crate::BitWriter<'a, u8, CTRLC_SPEC, TCA04_A, O>;
impl<'a, const O: u8> TCA04_W<'a, O> {
    #[doc = "Default pin"]
    #[inline(always)]
    pub fn default(self) -> &'a mut W {
...
pub type TCA05_W<'a, const O: u8> = crate::BitWriter<'a, u8, CTRLC_SPEC, TCA05_A, O>;
impl<'a, const O: u8> TCA05_W<'a, O> {
    #[doc = "Default pin"]
    #[inline(always)]
    pub fn default(self) -> &'a mut W {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tca04(&mut self) -> TCA04_W<4> {
        TCA04_W::new(self)
    }
    #[doc = "Bit 5 - Port Multiplexer TCA0 Output 5"]
    #[inline(always)]
    #[must_use]
    pub fn tca05(&mut self) -> TCA05_W<5> {
        TCA05_W::new(self)
    }
