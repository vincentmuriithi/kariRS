...
pub struct RegisterBlock {
    ...
    pub timsk1: TIMSK1,
    _reserved2: [u8; 0x12],
    #[doc = "0x14 - Timer/Counter1 Control Register C"]
    pub tccr1c: TCCR1C,
    #[doc = "0x15 - General Timer/Counter Control Register"]
    pub gtccr: GTCCR,
    #[doc = "0x16 - Timer/Counter1 Input Capture Register Bytes"]
    pub icr1: ICR1,
    _reserved5: [u8; 0x02],
    #[doc = "0x1a - Timer/Counter1 Output Compare Register B Bytes"]
    pub ocr1b: OCR1B,
    #[doc = "0x1c - Timer/Counter1 Output Compare Register A Bytes"]
    pub ocr1a: OCR1A,
    #[doc = "0x1e - Timer/Counter1 Bytes"]
    pub tcnt1: TCNT1,
    #[doc = "0x20 - Timer/Counter1 Control Register B"]
    pub tccr1b: TCCR1B,
    #[doc = "0x21 - Timer/Counter1 Control Register A"]
    pub tccr1a: TCCR1A,
}
