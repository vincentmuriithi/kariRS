...
pub type TWSME_R = crate::BitReader<bool>;
#[doc = "Field `TWSME` writer - TWI Smart Mode Enable"]
pub type TWSME_W<'a, const O: u8> = crate::BitWriter<'a, u8, TWSCRA_SPEC, bool, O>;
#[doc = "Field `TWPME` reader - TWI Promiscuous Mode Enable"]
pub type TWPME_R = crate::BitReader<bool>;
#[doc = "Field `TWPME` writer - TWI Promiscuous Mode Enable"]
pub type TWPME_W<'a, const O: u8> = crate::BitWriter<'a, u8, TWSCRA_SPEC, bool, O>;
#[doc = "Field `TWSIE` reader - TWI Stop Interrupt Enable"]
pub type TWSIE_R = crate::BitReader<bool>;
#[doc = "Field `TWSIE` writer - TWI Stop Interrupt Enable"]
pub type TWSIE_W<'a, const O: u8> = crate::BitWriter<'a, u8, TWSCRA_SPEC, bool, O>;
...
pub type TWEN_W<'a, const O: u8> = crate::BitWriter<'a, u8, TWSCRA_SPEC, bool, O>;
#[doc = "Field `TWASIE` reader - TWI Address/Stop Interrupt Enable"]
pub type TWASIE_R = crate::BitReader<bool>;
#[doc = "Field `TWASIE` writer - TWI Address/Stop Interrupt Enable"]
pub type TWASIE_W<'a, const O: u8> = crate::BitWriter<'a, u8, TWSCRA_SPEC, bool, O>;
#[doc = "Field `TWDIE` reader - TWI Data Interrupt Enable"]
pub type TWDIE_R = crate::BitReader<bool>;
#[doc = "Field `TWDIE` writer - TWI Data Interrupt Enable"]
pub type TWDIE_W<'a, const O: u8> = crate::BitWriter<'a, u8, TWSCRA_SPEC, bool, O>;
#[doc = "Field `TWSHE` reader - TWI SDA Hold Time Enable"]
pub type TWSHE_R = crate::BitReader<bool>;
#[doc = "Field `TWSHE` writer - TWI SDA Hold Time Enable"]
pub type TWSHE_W<'a, const O: u8> = crate::BitWriter<'a, u8, TWSCRA_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn twsme(&mut self) -> TWSME_W<0> {
        TWSME_W::new(self)
    }
    #[doc = "Bit 1 - TWI Promiscuous Mode Enable"]
    #[inline(always)]
    #[must_use]
    pub fn twpme(&mut self) -> TWPME_W<1> {
        TWPME_W::new(self)
    }
    #[doc = "Bit 2 - TWI Stop Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn twsie(&mut self) -> TWSIE_W<2> {
        TWSIE_W::new(self)
    }
    #[doc = "Bit 3 - Two-Wire Interface Enable"]
    #[inline(always)]
    #[must_use]
    pub fn twen(&mut self) -> TWEN_W<3> {
        TWEN_W::new(self)
    }
    #[doc = "Bit 4 - TWI Address/Stop Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn twasie(&mut self) -> TWASIE_W<4> {
        TWASIE_W::new(self)
    }
    #[doc = "Bit 5 - TWI Data Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn twdie(&mut self) -> TWDIE_W<5> {
        TWDIE_W::new(self)
    }
    #[doc = "Bit 7 - TWI SDA Hold Time Enable"]
    #[inline(always)]
    #[must_use]
    pub fn twshe(&mut self) -> TWSHE_W<7> {
        TWSHE_W::new(self)
    }
