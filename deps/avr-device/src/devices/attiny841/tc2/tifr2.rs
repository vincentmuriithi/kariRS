...
pub type ICF2_R = crate::BitReader<bool>;
#[doc = "Field `ICF2` writer - Timer/Counter2 Input Capture Flag"]
pub type ICF2_W<'a, const O: u8> = crate::BitWriter<'a, u8, TIFR2_SPEC, bool, O>;
impl R {
