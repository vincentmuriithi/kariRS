...
pub type ICIE2_R = crate::BitReader<bool>;
#[doc = "Field `ICIE2` writer - Timer/Counter2 Input Capture Interrupt Enable"]
pub type ICIE2_W<'a, const O: u8> = crate::BitWriter<'a, u8, TIMSK2_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn icie2(&mut self) -> ICIE2_W<5> {
        ICIE2_W::new(self)
    }
