...
pub type WGM2_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, TCCR2B_SPEC, u8, u8, 2, O>;
#[doc = "Field `ICES2` reader - Input Capture 2 Edge Select"]
pub type ICES2_R = crate::BitReader<bool>;
#[doc = "Field `ICES2` writer - Input Capture 2 Edge Select"]
pub type ICES2_W<'a, const O: u8> = crate::BitWriter<'a, u8, TCCR2B_SPEC, bool, O>;
#[doc = "Field `ICNC2` reader - Input Capture 2 Noise Canceler"]
pub type ICNC2_R = crate::BitReader<bool>;
#[doc = "Field `ICNC2` writer - Input Capture 2 Noise Canceler"]
pub type ICNC2_W<'a, const O: u8> = crate::BitWriter<'a, u8, TCCR2B_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wgm2(&mut self) -> WGM2_W<3> {
        WGM2_W::new(self)
    }
    #[doc = "Bit 6 - Input Capture 2 Edge Select"]
    #[inline(always)]
    #[must_use]
    pub fn ices2(&mut self) -> ICES2_W<6> {
        ICES2_W::new(self)
    }
    #[doc = "Bit 7 - Input Capture 2 Noise Canceler"]
    #[inline(always)]
    #[must_use]
    pub fn icnc2(&mut self) -> ICNC2_W<7> {
        ICNC2_W::new(self)
    }
