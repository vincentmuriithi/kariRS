...
pub type SFDE0_R = crate::BitReader<bool>;
#[doc = "Field `SFDE0` writer - USART RX Start Frame Detection Enable"]
pub type SFDE0_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCSR0D_SPEC, bool, O>;
#[doc = "Field `RXS0` reader - USART RX Start Flag"]
pub type RXS0_R = crate::BitReader<bool>;
#[doc = "Field `RXS0` writer - USART RX Start Flag"]
pub type RXS0_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCSR0D_SPEC, bool, O>;
#[doc = "Field `RXSIE0` reader - USART RX Start Interrupt Enable"]
pub type RXSIE0_R = crate::BitReader<bool>;
#[doc = "Field `RXSIE0` writer - USART RX Start Interrupt Enable"]
pub type RXSIE0_W<'a, const O: u8> = crate::BitWriter<'a, u8, UCSR0D_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sfde0(&mut self) -> SFDE0_W<5> {
        SFDE0_W::new(self)
    }
    #[doc = "Bit 6 - USART RX Start Flag"]
    #[inline(always)]
    #[must_use]
    pub fn rxs0(&mut self) -> RXS0_W<6> {
        RXS0_W::new(self)
    }
    #[doc = "Bit 7 - USART RX Start Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rxsie0(&mut self) -> RXSIE0_W<7> {
        RXSIE0_W::new(self)
    }
