...
pub type PRUSART1_W<'a, const O: u8> = crate::BitWriter<'a, u8, PRR_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 2 - Power Reduction Timer/Counter1"]
    #[inline(always)]
    pub fn prtim1(&self) -> PRTIM1_R {
        PRTIM1_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Power Reduction Timer/Counter2"]
    #[inline(always)]
    pub fn prtim2(&self) -> PRTIM2_R {
        PRTIM2_R::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    #[doc = "Bit 5 - Power Reduction USART0"]
    #[inline(always)]
    pub fn prusart0(&self) -> PRUSART0_R {
        PRUSART0_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - Power Reduction USART1"]
    #[inline(always)]
    pub fn prusart1(&self) -> PRUSART1_R {
        PRUSART1_R::new(((self.bits >> 6) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn prtim1(&mut self) -> PRTIM1_W<2> {
        PRTIM1_W::new(self)
    }
    #[doc = "Bit 3 - Power Reduction Timer/Counter2"]
    #[inline(always)]
    #[must_use]
    pub fn prtim2(&mut self) -> PRTIM2_W<3> {
        PRTIM2_W::new(self)
    }
    #[doc = "Bit 4 - Power Reduction SPI"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn prusart0(&mut self) -> PRUSART0_W<5> {
        PRUSART0_W::new(self)
    }
    #[doc = "Bit 6 - Power Reduction USART1"]
    #[inline(always)]
    #[must_use]
    pub fn prusart1(&mut self) -> PRUSART1_W<6> {
        PRUSART1_W::new(self)
    }
    #[doc = "Bit 7 - Power Reduction TWI"]
    #[inline(always)]
