...
pub struct R(crate::R<OSCTCAL0A_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OSCTCAL0A_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OSCTCAL0A_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OSCTCAL0A_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OSCTCAL0A` writer"]
pub struct W(crate::W<OSCTCAL0A_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OSCTCAL0A_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OSCTCAL0A_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OSCTCAL0A_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
