...
pub struct R(crate::R<PUEB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PUEB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PUEB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PUEB_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PUEB` writer"]
pub struct W(crate::W<PUEB_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PUEB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PUEB_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PUEB_SPEC>) -> Self {
        W(writer)
    }
}
