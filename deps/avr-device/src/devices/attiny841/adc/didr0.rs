...
#[doc = "Field `ADC0D` reader - ADC0/AREF Digital input Disable"]
pub type ADC0D_R = crate::BitReader<bool>;
#[doc = "Field `ADC0D` writer - ADC0/AREF Digital input Disable"]
pub type ADC0D_W<'a, const O: u8> = crate::BitWriter<'a, u8, DIDR0_SPEC, bool, O>;
#[doc = "Field `ADC1D` reader - ADC1/AIN00 Digital input Disable"]
pub type ADC1D_R = crate::BitReader<bool>;
#[doc = "Field `ADC1D` writer - ADC1/AIN00 Digital input Disable"]
pub type ADC1D_W<'a, const O: u8> = crate::BitWriter<'a, u8, DIDR0_SPEC, bool, O>;
#[doc = "Field `ADC2D` reader - ADC2/AIN01 Digital input Disable"]
pub type ADC2D_R = crate::BitReader<bool>;
#[doc = "Field `ADC2D` writer - ADC2/AIN01 Digital input Disable"]
pub type ADC2D_W<'a, const O: u8> = crate::BitWriter<'a, u8, DIDR0_SPEC, bool, O>;
#[doc = "Field `ADC3D` reader - ADC3/AIN10 Digital Input Disable"]
pub type ADC3D_R = crate::BitReader<bool>;
#[doc = "Field `ADC3D` writer - ADC3/AIN10 Digital Input Disable"]
pub type ADC3D_W<'a, const O: u8> = crate::BitWriter<'a, u8, DIDR0_SPEC, bool, O>;
#[doc = "Field `ADC4D` reader - ADC4/AIN11 Digital input Disable"]
pub type ADC4D_R = crate::BitReader<bool>;
#[doc = "Field `ADC4D` writer - ADC4/AIN11 Digital input Disable"]
...
impl R {
    #[doc = "Bit 0 - ADC0/AREF Digital input Disable"]
    #[inline(always)]
    pub fn adc0d(&self) -> ADC0D_R {
        ADC0D_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - ADC1/AIN00 Digital input Disable"]
    #[inline(always)]
    pub fn adc1d(&self) -> ADC1D_R {
        ADC1D_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - ADC2/AIN01 Digital input Disable"]
    #[inline(always)]
    pub fn adc2d(&self) -> ADC2D_R {
        ADC2D_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - ADC3/AIN10 Digital Input Disable"]
    #[inline(always)]
    pub fn adc3d(&self) -> ADC3D_R {
        ADC3D_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - ADC4/AIN11 Digital input Disable"]
    #[inline(always)]
