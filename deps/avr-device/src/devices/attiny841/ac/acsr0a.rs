...
pub type ACIS0_R = crate::FieldReader<u8, ACIS0_A>;
...
pub type ACIS0_W<'a, const O: u8> = crate::FieldWriter<'a, u8, ACSR0A_SPEC, u8, ACIS0_A, 2, O>;
impl<'a, const O: u8> ACIS0_W<'a, O> {
...
pub type ACIC0_W<'a, const O: u8> = crate::BitWriter<'a, u8, ACSR0A_SPEC, bool, O>;
#[doc = "Field `ACIE0` reader - Analog Comparator 0 Interrupt Enable"]
pub type ACIE0_R = crate::BitReader<bool>;
#[doc = "Field `ACIE0` writer - Analog Comparator 0 Interrupt Enable"]
pub type ACIE0_W<'a, const O: u8> = crate::BitWriter<'a, u8, ACSR0A_SPEC, bool, O>;
#[doc = "Field `ACI0` reader - Analog Comparator 0 Interrupt Flag"]
pub type ACI0_R = crate::BitReader<bool>;
#[doc = "Field `ACI0` writer - Analog Comparator 0 Interrupt Flag"]
pub type ACI0_W<'a, const O: u8> = crate::BitWriter<'a, u8, ACSR0A_SPEC, bool, O>;
#[doc = "Field `ACO0` reader - Analog Comparator 0 Output"]
pub type ACO0_R = crate::BitReader<bool>;
#[doc = "Field `ACO0` writer - Analog Comparator 0 Output"]
pub type ACO0_W<'a, const O: u8> = crate::BitWriter<'a, u8, ACSR0A_SPEC, bool, O>;
...
pub type ACPMUX2_W<'a, const O: u8> = crate::BitWriter<'a, u8, ACSR0A_SPEC, bool, O>;
#[doc = "Field `ACD0` reader - Analog Comparator 0 Disable"]
pub type ACD0_R = crate::BitReader<bool>;
#[doc = "Field `ACD0` writer - Analog Comparator 0 Disable"]
pub type ACD0_W<'a, const O: u8> = crate::BitWriter<'a, u8, ACSR0A_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn acis0(&mut self) -> ACIS0_W<0> {
        ACIS0_W::new(self)
    }
    #[doc = "Bit 2 - Analog Comparator 0 Input Capture Enable"]
    #[inline(always)]
    #[must_use]
    pub fn acic0(&mut self) -> ACIC0_W<2> {
        ACIC0_W::new(self)
    }
    #[doc = "Bit 3 - Analog Comparator 0 Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn acie0(&mut self) -> ACIE0_W<3> {
        ACIE0_W::new(self)
    }
    #[doc = "Bit 4 - Analog Comparator 0 Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn aci0(&mut self) -> ACI0_W<4> {
        ACI0_W::new(self)
    }
    #[doc = "Bit 5 - Analog Comparator 0 Output"]
    #[inline(always)]
    #[must_use]
    pub fn aco0(&mut self) -> ACO0_W<5> {
        ACO0_W::new(self)
    }
    #[doc = "Bit 6 - Analog Comparator 0 Positive Input Multiplexer Bit 2"]
    #[inline(always)]
