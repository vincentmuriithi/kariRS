...
#[doc = "Field `RSTDISBL` reader - External reset disable"]
pub type RSTDISBL_R = crate::BitReader<bool>;
#[doc = "Field `RSTDISBL` writer - External reset disable"]
...
#[doc = "Field `SPIEN` reader - Serial program downloading (SPI) enable"]
pub type SPIEN_R = crate::BitReader<bool>;
#[doc = "Field `SPIEN` writer - Serial program downloading (SPI) enable"]
...
impl R {
    ...
    #[doc = "Bits 1:3 - Brown-out Detector trigger level"]
    #[inline(always)]
    pub fn bodlevel(&self) -> BODLEVEL_R {
        BODLEVEL_R::new((self.bits >> 1) & 7)
    }
    ...
    #[doc = "Bit 5 - Serial program downloading (SPI) enable"]
    #[inline(always)]
