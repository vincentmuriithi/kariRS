#![doc = "Peripheral access API for ATTINY26 microcontrollers (generated using svd2rust v0.28.0 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl CPU {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const cpu::RegisterBlock = 0x51 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
...
impl TC1 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const tc1::RegisterBlock = 0x49 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
