...
impl ISC0_R {
    ...
    pub fn variant(&self) -> ISC0_A {
        match self.bits {
            ...
            1 => ISC0_A::ANY_LOGICAL_CHANGE_IN_INTX,
    ...
    #[doc = "Checks if the value of the field is `ANY_LOGICAL_CHANGE_IN_INTX`"]
    #[inline(always)]
    pub fn is_any_logical_change_in_intx(&self) -> bool {
        *self == ISC0_A::ANY_LOGICAL_CHANGE_IN_INTX
    }
...
impl<'a, const O: u8> ISC0_W<'a, O> {
    ...
    #[inline(always)]
    pub fn any_logical_change_in_intx(self) -> &'a mut W {
        self.variant(ISC0_A::ANY_LOGICAL_CHANGE_IN_INTX)
    }
