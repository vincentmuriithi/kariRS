...
#[doc = "Field `OCIE1B` reader - Timer/Counter1 Output Compare Interrupt Enable"]
pub type OCIE1B_R = crate::BitReader<bool>;
#[doc = "Field `OCIE1B` writer - Timer/Counter1 Output Compare Interrupt Enable"]
pub type OCIE1B_W<'a, const O: u8> = crate::BitWriter<'a, u8, TIMSK_SPEC, bool, O>;
#[doc = "Field `OCIE1A` reader - Timer/Counter1 Output Compare Interrupt Enable"]
pub type OCIE1A_R = crate::BitReader<bool>;
#[doc = "Field `OCIE1A` writer - Timer/Counter1 Output Compare Interrupt Enable"]
...
impl R {
    ...
    #[doc = "Bit 5 - Timer/Counter1 Output Compare Interrupt Enable"]
    #[inline(always)]
    pub fn ocie1b(&self) -> OCIE1B_R {
        OCIE1B_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - Timer/Counter1 Output Compare Interrupt Enable"]
    #[inline(always)]
