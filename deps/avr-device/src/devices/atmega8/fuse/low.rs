...
pub enum SUT_CKSEL_A {
    ...
    EXTCLK_6CK_64MS = 32,
    #[doc = "33: Int. RC Osc. 1 MHz; Start-up time: 6 CK + 64 ms; default value"]
    INTRCOSC_1MHZ_6CK_64MS_DEFAULT = 33,
...
impl SUT_CKSEL_R {
    ...
    pub fn variant(&self) -> Option<SUT_CKSEL_A> {
        match self.bits {
            ...
            33 => Some(SUT_CKSEL_A::INTRCOSC_1MHZ_6CK_64MS_DEFAULT),
    ...
    #[doc = "Checks if the value of the field is `INTRCOSC_1MHZ_6CK_64MS_DEFAULT`"]
    #[inline(always)]
    pub fn is_intrcosc_1mhz_6ck_64ms_default(&self) -> bool {
        *self == SUT_CKSEL_A::INTRCOSC_1MHZ_6CK_64MS_DEFAULT
    }
...
pub type BODEN_W<'a, const O: u8> = crate::BitWriter<'a, u8, LOW_SPEC, bool, O>;
...
pub type BODLEVEL_W<'a, const O: u8> = crate::BitWriter<'a, u8, LOW_SPEC, BODLEVEL_A, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn boden(&mut self) -> BODEN_W<6> {
        BODEN_W::new(self)
    }
    #[doc = "Bit 7 - Brownout detector trigger level"]
    #[inline(always)]
    #[must_use]
    pub fn bodlevel(&mut self) -> BODLEVEL_W<7> {
        BODLEVEL_W::new(self)
    }
