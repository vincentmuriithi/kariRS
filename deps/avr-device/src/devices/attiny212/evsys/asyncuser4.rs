...
#[doc = "Field `ASYNCUSER4` reader - synchronous User Ch 4 Input Selection - CCL LUT0 Event 1"]
pub type ASYNCUSER4_R = crate::FieldReader<u8, ASYNCUSER4_A>;
#[doc = "synchronous User Ch 4 Input Selection - CCL LUT0 Event 1\n\nValue on reset: 0"]
...
#[doc = "Field `ASYNCUSER4` writer - synchronous User Ch 4 Input Selection - CCL LUT0 Event 1"]
...
impl R {
    #[doc = "Bits 0:7 - synchronous User Ch 4 Input Selection - CCL LUT0 Event 1"]
    #[inline(always)]
