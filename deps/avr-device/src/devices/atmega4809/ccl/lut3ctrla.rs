...
pub type ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u8, LUT3CTRLA_SPEC, bool, O>;
...
pub type CLKSRC_W<'a, const O: u8> = crate::FieldWriter<'a, u8, LUT3CTRLA_SPEC, u8, CLKSRC_A, 3, O>;
...
pub type FILTSEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, LUT3CTRLA_SPEC, u8, FILTSEL_A, 2, O>;
...
pub type OUTEN_W<'a, const O: u8> = crate::BitWriter<'a, u8, LUT3CTRLA_SPEC, bool, O>;
...
pub type EDGEDET_W<'a, const O: u8> = crate::BitWriter<'a, u8, LUT3CTRLA_SPEC, EDGEDET_A, O>;
