...
pub enum MUXPOS_A {
    ...
    AIN11 = 11,
    #[doc = "12: ADC input pin 12"]
    AIN12 = 12,
    #[doc = "13: ADC input pin 13"]
    AIN13 = 13,
    #[doc = "14: ADC input pin 14"]
    AIN14 = 14,
    #[doc = "15: ADC input pin 15"]
    AIN15 = 15,
    #[doc = "28: AC DAC Reference"]
    DACREF = 28,
    #[doc = "30: Temperature sensor"]
    TEMPSENSE = 30,
    #[doc = "31: 0V (GND)"]
    GND = 31,
}
...
impl MUXPOS_R {
    ...
    pub fn variant(&self) -> Option<MUXPOS_A> {
        match self.bits {
            ...
            12 => Some(MUXPOS_A::AIN12),
            13 => Some(MUXPOS_A::AIN13),
            14 => Some(MUXPOS_A::AIN14),
            15 => Some(MUXPOS_A::AIN15),
            28 => Some(MUXPOS_A::DACREF),
...
pub type MUXPOS_W<'a, const O: u8> = crate::FieldWriter<'a, u8, MUXPOS_SPEC, u8, MUXPOS_A, 5, O>;
