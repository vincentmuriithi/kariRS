...
pub struct R(crate::R<USERROW41_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USERROW41_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USERROW41_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USERROW41_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USERROW41` writer"]
pub struct W(crate::W<USERROW41_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USERROW41_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USERROW41_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USERROW41_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
