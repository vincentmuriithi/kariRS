...
pub struct R(crate::R<CHANNEL3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CHANNEL3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CHANNEL3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CHANNEL3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CHANNEL3` writer"]
pub struct W(crate::W<CHANNEL3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CHANNEL3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CHANNEL3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CHANNEL3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type GENERATOR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, CHANNEL3_SPEC, u8, GENERATOR_A, 8, O>;
