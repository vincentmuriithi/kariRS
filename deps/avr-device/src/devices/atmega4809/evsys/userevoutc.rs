#[doc = "Register `USEREVOUTC` reader"]
pub struct R(crate::R<USEREVOUTC_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USEREVOUTC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USEREVOUTC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USEREVOUTC_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USEREVOUTC` writer"]
pub struct W(crate::W<USEREVOUTC_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USEREVOUTC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USEREVOUTC_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USEREVOUTC_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHANNEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, USEREVOUTC_SPEC, u8, CHANNEL_A, 8, O>;
...
pub struct USEREVOUTC_SPEC;
impl crate::RegisterSpec for USEREVOUTC_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [userevoutc::R](R) reader structure"]
impl crate::Readable for USEREVOUTC_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [userevoutc::W](W) writer structure"]
impl crate::Writable for USEREVOUTC_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USEREVOUTC to value 0"]
impl crate::Resettable for USEREVOUTC_SPEC {
