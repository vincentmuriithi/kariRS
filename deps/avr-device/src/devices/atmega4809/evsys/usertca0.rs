#[doc = "Register `USERTCA0` reader"]
pub struct R(crate::R<USERTCA0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USERTCA0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USERTCA0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USERTCA0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USERTCA0` writer"]
pub struct W(crate::W<USERTCA0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USERTCA0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USERTCA0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USERTCA0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHANNEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, USERTCA0_SPEC, u8, CHANNEL_A, 8, O>;
...
pub struct USERTCA0_SPEC;
impl crate::RegisterSpec for USERTCA0_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [usertca0::R](R) reader structure"]
impl crate::Readable for USERTCA0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [usertca0::W](W) writer structure"]
impl crate::Writable for USERTCA0_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USERTCA0 to value 0"]
impl crate::Resettable for USERTCA0_SPEC {
