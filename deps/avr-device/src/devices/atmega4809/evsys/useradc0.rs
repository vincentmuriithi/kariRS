#[doc = "Register `USERADC0` reader"]
pub struct R(crate::R<USERADC0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USERADC0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USERADC0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USERADC0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USERADC0` writer"]
pub struct W(crate::W<USERADC0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USERADC0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USERADC0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USERADC0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHANNEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, USERADC0_SPEC, u8, CHANNEL_A, 8, O>;
...
pub struct USERADC0_SPEC;
impl crate::RegisterSpec for USERADC0_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [useradc0::R](R) reader structure"]
impl crate::Readable for USERADC0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [useradc0::W](W) writer structure"]
impl crate::Writable for USERADC0_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USERADC0 to value 0"]
impl crate::Resettable for USERADC0_SPEC {
