#[doc = "Register `USEREVOUTA` reader"]
pub struct R(crate::R<USEREVOUTA_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USEREVOUTA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USEREVOUTA_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USEREVOUTA_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USEREVOUTA` writer"]
pub struct W(crate::W<USEREVOUTA_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USEREVOUTA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USEREVOUTA_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USEREVOUTA_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHANNEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, USEREVOUTA_SPEC, u8, CHANNEL_A, 8, O>;
...
pub struct USEREVOUTA_SPEC;
impl crate::RegisterSpec for USEREVOUTA_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [userevouta::R](R) reader structure"]
impl crate::Readable for USEREVOUTA_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [userevouta::W](W) writer structure"]
impl crate::Writable for USEREVOUTA_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USEREVOUTA to value 0"]
impl crate::Resettable for USEREVOUTA_SPEC {
