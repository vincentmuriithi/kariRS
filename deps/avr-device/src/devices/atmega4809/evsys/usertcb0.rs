...
pub struct R(crate::R<USERTCB0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USERTCB0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USERTCB0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USERTCB0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USERTCB0` writer"]
pub struct W(crate::W<USERTCB0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USERTCB0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USERTCB0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USERTCB0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHANNEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, USERTCB0_SPEC, u8, CHANNEL_A, 8, O>;
