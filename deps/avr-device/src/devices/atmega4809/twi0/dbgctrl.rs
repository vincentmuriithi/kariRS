...
#[doc = "Field `DEFAULT_DBGRUN` reader - Debug Run"]
pub type DEFAULT_DBGRUN_R = crate::BitReader<bool>;
#[doc = "Field `DEFAULT_DBGRUN` writer - Debug Run"]
pub type DEFAULT_DBGRUN_W<'a, const O: u8> = crate::BitWriter<'a, u8, DBGCTRL_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - Debug Run"]
    #[inline(always)]
    pub fn default_dbgrun(&self) -> DEFAULT_DBGRUN_R {
        DEFAULT_DBGRUN_R::new((self.bits & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Debug Run"]
    #[inline(always)]
    #[must_use]
    pub fn default_dbgrun(&mut self) -> DEFAULT_DBGRUN_W<0> {
        DEFAULT_DBGRUN_W::new(self)
    }
