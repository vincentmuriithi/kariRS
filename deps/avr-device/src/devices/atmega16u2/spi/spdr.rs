...
#[doc = "Field `SPDR` reader - SPI Data bits"]
pub type SPDR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SPDR` writer - SPI Data bits"]
pub type SPDR_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, SPDR_SPEC, u8, u8, 8, O>;
impl R {
