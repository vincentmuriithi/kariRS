...
#[doc = "Field `OCIE1C` reader - Timer/Counter1 Output Compare C Match Interrupt Enable"]
pub type OCIE1C_R = crate::BitReader<bool>;
#[doc = "Field `OCIE1C` writer - Timer/Counter1 Output Compare C Match Interrupt Enable"]
pub type OCIE1C_W<'a, const O: u8> = crate::BitWriter<'a, u8, TIMSK1_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 3 - Timer/Counter1 Output Compare C Match Interrupt Enable"]
    #[inline(always)]
    pub fn ocie1c(&self) -> OCIE1C_R {
        OCIE1C_R::new(((self.bits >> 3) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ocie1c(&mut self) -> OCIE1C_W<3> {
        OCIE1C_W::new(self)
    }
    #[doc = "Bit 5 - Timer/Counter1 Input Capture Interrupt Enable"]
    #[inline(always)]
