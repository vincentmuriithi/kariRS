...
#[doc = "Field `USBRF` reader - USB reset flag"]
pub type USBRF_R = crate::BitReader<bool>;
#[doc = "Field `USBRF` writer - USB reset flag"]
pub type USBRF_W<'a, const O: u8> = crate::BitWriter<'a, u8, MCUSR_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 5 - USB reset flag"]
    #[inline(always)]
    pub fn usbrf(&self) -> USBRF_R {
        USBRF_R::new(((self.bits >> 5) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Power-on reset flag"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn usbrf(&mut self) -> USBRF_W<5> {
        USBRF_W::new(self)
    }
