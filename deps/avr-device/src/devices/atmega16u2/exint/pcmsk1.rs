...
#[doc = "Field `PCINT` reader - No Description."]
pub type PCINT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PCINT` writer - No Description."]
pub type PCINT_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, PCMSK1_SPEC, u8, u8, 5, O>;
impl R {
    #[doc = "Bits 0:4 - No Description."]
    #[inline(always)]
    pub fn pcint(&self) -> PCINT_R {
        PCINT_R::new(self.bits & 0x1f)
    }
}
impl W {
    #[doc = "Bits 0:4 - No Description."]
