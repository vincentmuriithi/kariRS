#[doc = "Register `DDRD` reader"]
pub struct R(crate::R<DDRD_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DDRD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DDRD_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DDRD_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DDRD` writer"]
pub struct W(crate::W<DDRD_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DDRD_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DDRD_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DDRD_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "`read()` method returns [ddrd::R](R) reader structure"]
impl crate::Readable for DDRD_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ddrd::W](W) writer structure"]
impl crate::Writable for DDRD_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DDRD to value 0"]
