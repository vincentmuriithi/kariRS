...
#[doc = "Field `PCINT` reader - Pin Change Interrupt Masks"]
pub type PCINT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PCINT` writer - Pin Change Interrupt Masks"]
pub type PCINT_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, PCMSK1_SPEC, u8, u8, 3, O>;
impl R {
    #[doc = "Bits 0:2 - Pin Change Interrupt Masks"]
    #[inline(always)]
    pub fn pcint(&self) -> PCINT_R {
        PCINT_R::new(self.bits & 7)
    }
}
impl W {
    #[doc = "Bits 0:2 - Pin Change Interrupt Masks"]
