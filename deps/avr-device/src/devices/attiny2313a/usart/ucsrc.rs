...
pub type UMSEL_R = crate::FieldReader<u8, UMSEL_A>;
...
impl UMSEL_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<UMSEL_A> {
        match self.bits {
            0 => Some(UMSEL_A::USART_ASYNC),
            1 => Some(UMSEL_A::USART_SYNC),
            3 => Some(UMSEL_A::SPI_MASTER),
            _ => None,
        }
    }
    ...
    pub fn is_spi_master(&self) -> bool {
        *self == UMSEL_A::SPI_MASTER
    }
}
#[doc = "Field `UMSEL` writer - USART Mode Select"]
pub type UMSEL_W<'a, const O: u8> = crate::FieldWriter<'a, u8, UCSRC_SPEC, u8, UMSEL_A, 2, O>;
impl<'a, const O: u8> UMSEL_W<'a, O> {
    ...
    pub fn spi_master(self) -> &'a mut W {
        self.variant(UMSEL_A::SPI_MASTER)
    }
}
impl R {
