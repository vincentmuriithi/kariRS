...
impl SUT_CKSEL_R {
    ...
    #[doc = "Checks if the value of the field is `INTRCOSC_4MHZ_14CK_0MS`"]
    #[inline(always)]
    pub fn is_intrcosc_4mhz_14ck_0ms(&self) -> bool {
        *self == SUT_CKSEL_A::INTRCOSC_4MHZ_14CK_0MS
    }
    #[doc = "Checks if the value of the field is `INTRCOSC_8MHZ_14CK_0MS`"]
    #[inline(always)]
    ...
    #[doc = "Checks if the value of the field is `EXTCLK_14CK_4MS1`"]
    #[inline(always)]
    pub fn is_extclk_14ck_4ms1(&self) -> bool {
        *self == SUT_CKSEL_A::EXTCLK_14CK_4MS1
    }
    #[doc = "Checks if the value of the field is `INTRCOSC_4MHZ_14CK_4MS1`"]
    #[inline(always)]
    pub fn is_intrcosc_4mhz_14ck_4ms1(&self) -> bool {
        *self == SUT_CKSEL_A::INTRCOSC_4MHZ_14CK_4MS1
    }
    #[doc = "Checks if the value of the field is `INTRCOSC_8MHZ_14CK_4MS1`"]
    #[inline(always)]
