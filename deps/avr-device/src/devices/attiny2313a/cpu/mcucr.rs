...
impl SM_R {
    ...
    #[doc = "Checks if the value of the field is `PDOWN2`"]
    #[inline(always)]
...
pub type SM_W<'a, const O: u8> = crate::FieldWriter<'a, u8, MCUCR_SPEC, u8, SM_A, 3, O>;
