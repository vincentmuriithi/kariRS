...
pub type ICIE1_W<'a, const O: u8> = crate::BitWriter<'a, u8, TIMSK_SPEC, bool, O>;
...
impl R {
    #[doc = "Bit 3 - Timer/Counter1 Input Capture Interrupt Enable"]
    #[inline(always)]
    pub fn icie1(&self) -> ICIE1_R {
        ICIE1_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 5 - Timer/Counter1 Output CompareB Match Interrupt Enable"]
    #[inline(always)]
    pub fn ocie1b(&self) -> OCIE1B_R {
        OCIE1B_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - Timer/Counter1 Output CompareA Match Interrupt Enable"]
    #[inline(always)]
    pub fn ocie1a(&self) -> OCIE1A_R {
        OCIE1A_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - Timer/Counter1 Overflow Interrupt Enable"]
    #[inline(always)]
    pub fn toie1(&self) -> TOIE1_R {
        TOIE1_R::new(((self.bits >> 7) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 3 - Timer/Counter1 Input Capture Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn icie1(&mut self) -> ICIE1_W<3> {
        ICIE1_W::new(self)
    }
    #[doc = "Bit 5 - Timer/Counter1 Output CompareB Match Interrupt Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn toie1(&mut self) -> TOIE1_W<7> {
        TOIE1_W::new(self)
    }
