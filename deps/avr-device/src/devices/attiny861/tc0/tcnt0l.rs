...
pub struct R(crate::R<TCNT0L_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TCNT0L_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TCNT0L_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TCNT0L_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TCNT0L` writer"]
pub struct W(crate::W<TCNT0L_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TCNT0L_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TCNT0L_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TCNT0L_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
