...
#[doc = "Field `TICIE0` reader - Timer/Counter0 Input Capture Interrupt Enable"]
pub type TICIE0_R = crate::BitReader<bool>;
#[doc = "Field `TICIE0` writer - Timer/Counter0 Input Capture Interrupt Enable"]
pub type TICIE0_W<'a, const O: u8> = crate::BitWriter<'a, u8, TIMSK_SPEC, bool, O>;
...
impl R {
    #[doc = "Bit 0 - Timer/Counter0 Input Capture Interrupt Enable"]
    #[inline(always)]
    pub fn ticie0(&self) -> TICIE0_R {
        TICIE0_R::new((self.bits & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ticie0(&mut self) -> TICIE0_W<0> {
        TICIE0_W::new(self)
    }
    #[doc = "Bit 1 - Timer/Counter0 Overflow Interrupt Enable"]
    #[inline(always)]
