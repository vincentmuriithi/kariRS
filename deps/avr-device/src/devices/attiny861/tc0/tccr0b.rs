...
#[doc = "Field `PSR0` reader - Timer/Counter 0 Prescaler Reset"]
pub type PSR0_R = crate::BitReader<bool>;
#[doc = "Field `PSR0` writer - Timer/Counter 0 Prescaler Reset"]
pub type PSR0_W<'a, const O: u8> = crate::BitWriter<'a, u8, TCCR0B_SPEC, bool, O>;
...
pub type TSM_W<'a, const O: u8> = crate::BitWriter<'a, u8, TCCR0B_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 3 - Timer/Counter 0 Prescaler Reset"]
    #[inline(always)]
    pub fn psr0(&self) -> PSR0_R {
        PSR0_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - Timer/Counter Synchronization Mode"]
    #[inline(always)]
    pub fn tsm(&self) -> TSM_R {
        TSM_R::new(((self.bits >> 4) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:2 - Clock Select"]
