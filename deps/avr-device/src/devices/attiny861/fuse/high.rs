...
#[repr(u8)]
pub enum BODLEVEL_A {
    #[doc = "0: Brown-out detection at VCC=2.0 V"]
    _2V0 = 0,
    #[doc = "1: Brown-out detection at VCC=1.9 V"]
    _1V9 = 1,
    #[doc = "2: Brown-out detection at VCC=2.2 V"]
    _2V2 = 2,
    #[doc = "3: Brown-out detection at VCC=2.3 V"]
    _2V3 = 3,
...
pub type BODLEVEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u8, HIGH_SPEC, u8, BODLEVEL_A, 3, O>;
...
#[doc = "Field `RSTDISBL` writer - Reset Disabled (Enable PB7 as i/o pin)"]
...
impl R {
    ...
    #[doc = "Bit 7 - Reset Disabled (Enable PB7 as i/o pin)"]
    #[inline(always)]
