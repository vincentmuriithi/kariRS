...
pub type ACME_W<'a, const O: u8> = crate::BitWriter<'a, u8, ACSRA_SPEC, bool, O>;
...
pub type ACBG_W<'a, const O: u8> = crate::BitWriter<'a, u8, ACSRA_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 2 - Analog Comparator Multiplexer Enable"]
    #[inline(always)]
    pub fn acme(&self) -> ACME_R {
        ACME_R::new(((self.bits >> 2) & 1) != 0)
    }
