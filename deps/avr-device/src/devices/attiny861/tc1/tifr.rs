...
#[doc = "Field `OCF1B` reader - Timer/Counter1 Output Compare Flag 1B"]
pub type OCF1B_R = crate::BitReader<bool>;
#[doc = "Field `OCF1B` writer - Timer/Counter1 Output Compare Flag 1B"]
pub type OCF1B_W<'a, const O: u8> = crate::BitWriter<'a, u8, TIFR_SPEC, bool, O>;
#[doc = "Field `OCF1A` reader - Timer/Counter1 Output Compare Flag 1A"]
pub type OCF1A_R = crate::BitReader<bool>;
#[doc = "Field `OCF1A` writer - Timer/Counter1 Output Compare Flag 1A"]
pub type OCF1A_W<'a, const O: u8> = crate::BitWriter<'a, u8, TIFR_SPEC, bool, O>;
#[doc = "Field `OCF1D` reader - Timer/Counter1 Output Compare Flag 1D"]
pub type OCF1D_R = crate::BitReader<bool>;
#[doc = "Field `OCF1D` writer - Timer/Counter1 Output Compare Flag 1D"]
pub type OCF1D_W<'a, const O: u8> = crate::BitWriter<'a, u8, TIFR_SPEC, bool, O>;
impl R {
    #[doc = "Bit 2 - Timer/Counter1 Overflow Flag"]
    #[inline(always)]
    pub fn tov1(&self) -> TOV1_R {
        TOV1_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 5 - Timer/Counter1 Output Compare Flag 1B"]
    #[inline(always)]
    pub fn ocf1b(&self) -> OCF1B_R {
        OCF1B_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - Timer/Counter1 Output Compare Flag 1A"]
    #[inline(always)]
    pub fn ocf1a(&self) -> OCF1A_R {
        OCF1A_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - Timer/Counter1 Output Compare Flag 1D"]
    #[inline(always)]
    pub fn ocf1d(&self) -> OCF1D_R {
        OCF1D_R::new(((self.bits >> 7) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 2 - Timer/Counter1 Overflow Flag"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ocf1d(&mut self) -> OCF1D_W<7> {
        OCF1D_W::new(self)
    }
