...
pub type DTPS1_R = crate::FieldReader<u8, DTPS1_A>;
...
pub type DTPS1_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, TCCR1B_SPEC, u8, DTPS1_A, 2, O>;
impl<'a, const O: u8> DTPS1_W<'a, O> {
    #[doc = "1x (no division)"]
    #[inline(always)]
...
pub type PWM1X_R = crate::BitReader<bool>;
#[doc = "Field `PWM1X` writer - PWM Inversion Mode"]
pub type PWM1X_W<'a, const O: u8> = crate::BitWriter<'a, u8, TCCR1B_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dtps1(&mut self) -> DTPS1_W<4> {
        DTPS1_W::new(self)
    }
    #[doc = "Bit 6 - Timer/Counter 1 Prescaler reset"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pwm1x(&mut self) -> PWM1X_W<7> {
        PWM1X_W::new(self)
    }
