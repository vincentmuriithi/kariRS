...
pub struct R(crate::R<TC1H_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TC1H_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TC1H_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TC1H_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TC1H` writer"]
pub struct W(crate::W<TC1H_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TC1H_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TC1H_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TC1H_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
