...
#[doc = "Field `OCIE1D` reader - OCIE1D: Timer/Counter1 Output Compare Interrupt Enable"]
pub type OCIE1D_R = crate::BitReader<bool>;
#[doc = "Field `OCIE1D` writer - OCIE1D: Timer/Counter1 Output Compare Interrupt Enable"]
pub type OCIE1D_W<'a, const O: u8> = crate::BitWriter<'a, u8, TIMSK_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 7 - OCIE1D: Timer/Counter1 Output Compare Interrupt Enable"]
    #[inline(always)]
    pub fn ocie1d(&self) -> OCIE1D_R {
        OCIE1D_R::new(((self.bits >> 7) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 2 - Timer/Counter1 Overflow Interrupt Enable"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ocie1d(&mut self) -> OCIE1D_W<7> {
        OCIE1D_W::new(self)
    }
