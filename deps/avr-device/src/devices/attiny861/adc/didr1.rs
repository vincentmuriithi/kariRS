...
pub type ADC7D_W<'a, const O: u8> = crate::BitWriter<'a, u8, DIDR1_SPEC, bool, O>;
...
impl R {
    #[doc = "Bit 4 - ADC7 Digital input Disable"]
    #[inline(always)]
    pub fn adc7d(&self) -> ADC7D_R {
        ADC7D_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - ADC8 Digital input Disable"]
    #[inline(always)]
    pub fn adc8d(&self) -> ADC8D_R {
        ADC8D_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - ADC9 Digital input Disable"]
    #[inline(always)]
    pub fn adc9d(&self) -> ADC9D_R {
        ADC9D_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - ADC10 Digital input Disable"]
    #[inline(always)]
    pub fn adc10d(&self) -> ADC10D_R {
        ADC10D_R::new(((self.bits >> 7) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 4 - ADC7 Digital input Disable"]
    #[inline(always)]
    #[must_use]
    pub fn adc7d(&mut self) -> ADC7D_W<4> {
        ADC7D_W::new(self)
    }
    #[doc = "Bit 5 - ADC8 Digital input Disable"]
    #[inline(always)]
    #[must_use]
    pub fn adc8d(&mut self) -> ADC8D_W<5> {
        ADC8D_W::new(self)
    }
    #[doc = "Bit 6 - ADC9 Digital input Disable"]
    #[inline(always)]
    #[must_use]
    pub fn adc9d(&mut self) -> ADC9D_W<6> {
        ADC9D_W::new(self)
    }
    #[doc = "Bit 7 - ADC10 Digital input Disable"]
    #[inline(always)]
    #[must_use]
    pub fn adc10d(&mut self) -> ADC10D_W<7> {
        ADC10D_W::new(self)
    }
