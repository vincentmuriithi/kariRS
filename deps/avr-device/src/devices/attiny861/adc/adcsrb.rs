...
#[doc = "Field `MUX5` reader - Analog Channel and Gain Selection Bit 5"]
pub type MUX5_R = crate::BitReader<bool>;
#[doc = "Field `MUX5` writer - Analog Channel and Gain Selection Bit 5"]
pub type MUX5_W<'a, const O: u8> = crate::BitWriter<'a, u8, ADCSRB_SPEC, bool, O>;
#[doc = "Field `REFS2` reader - Reference Selection Bit"]
pub type REFS2_R = crate::BitReader<bool>;
#[doc = "Field `REFS2` writer - Reference Selection Bit"]
pub type REFS2_W<'a, const O: u8> = crate::BitWriter<'a, u8, ADCSRB_SPEC, bool, O>;
...
#[doc = "Field `GSEL` reader - Gain Select"]
pub type GSEL_R = crate::BitReader<bool>;
#[doc = "Field `GSEL` writer - Gain Select"]
pub type GSEL_W<'a, const O: u8> = crate::BitWriter<'a, u8, ADCSRB_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 3 - Analog Channel and Gain Selection Bit 5"]
    #[inline(always)]
    pub fn mux5(&self) -> MUX5_R {
        MUX5_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - Reference Selection Bit"]
    #[inline(always)]
    ...
    #[doc = "Bit 6 - Gain Select"]
    #[inline(always)]
    pub fn gsel(&self) -> GSEL_R {
        GSEL_R::new(((self.bits >> 6) & 1) != 0)
    }
