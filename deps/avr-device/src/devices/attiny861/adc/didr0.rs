...
#[doc = "Field `AREFD` reader - AREF Digital Input Disable"]
pub type AREFD_R = crate::BitReader<bool>;
#[doc = "Field `AREFD` writer - AREF Digital Input Disable"]
pub type AREFD_W<'a, const O: u8> = crate::BitWriter<'a, u8, DIDR0_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 3 - AREF Digital Input Disable"]
    #[inline(always)]
    pub fn arefd(&self) -> AREFD_R {
        AREFD_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - ADC3 Digital input Disable"]
    #[inline(always)]
    pub fn adc3d(&self) -> ADC3D_R {
        ADC3D_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - ADC4 Digital input Disable"]
    #[inline(always)]
    pub fn adc4d(&self) -> ADC4D_R {
        ADC4D_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - ADC5 Digital input Disable"]
    #[inline(always)]
    pub fn adc5d(&self) -> ADC5D_R {
        ADC5D_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - ADC6 Digital input Disable"]
    #[inline(always)]
    pub fn adc6d(&self) -> ADC6D_R {
        ADC6D_R::new(((self.bits >> 7) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - ADC0 Digital input Disable"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn arefd(&mut self) -> AREFD_W<3> {
        AREFD_W::new(self)
    }
    #[doc = "Bit 4 - ADC3 Digital input Disable"]
    #[inline(always)]
    #[must_use]
    pub fn adc3d(&mut self) -> ADC3D_W<4> {
        ADC3D_W::new(self)
    }
    #[doc = "Bit 5 - ADC4 Digital input Disable"]
    #[inline(always)]
    #[must_use]
    pub fn adc4d(&mut self) -> ADC4D_W<5> {
        ADC4D_W::new(self)
    }
    #[doc = "Bit 6 - ADC5 Digital input Disable"]
    #[inline(always)]
    #[must_use]
    pub fn adc5d(&mut self) -> ADC5D_W<6> {
        ADC5D_W::new(self)
    }
    #[doc = "Bit 7 - ADC6 Digital input Disable"]
    #[inline(always)]
    #[must_use]
    pub fn adc6d(&mut self) -> ADC6D_W<7> {
        ADC6D_W::new(self)
    }
