...
pub type OCR1A_R = crate::FieldReader<u16, u16>;
#[doc = "Field `OCR1A` writer - Timer/Counter1 Output Compare A bits"]
pub type OCR1A_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u16, OCR1A_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ocr1a(&mut self) -> OCR1A_W<0> {
        OCR1A_W::new(self)
    }
