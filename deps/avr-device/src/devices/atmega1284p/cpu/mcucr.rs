...
#[doc = "Field `BODSE` reader - BOD Power Down in Sleep Enable"]
pub type BODSE_R = crate::BitReader<bool>;
#[doc = "Field `BODSE` writer - BOD Power Down in Sleep Enable"]
pub type BODSE_W<'a, const O: u8> = crate::BitWriter<'a, u8, MCUCR_SPEC, bool, O>;
#[doc = "Field `BODS` reader - BOD Power Down in Sleep"]
pub type BODS_R = crate::BitReader<bool>;
#[doc = "Field `BODS` writer - BOD Power Down in Sleep"]
...
impl R {
    ...
    #[doc = "Bit 5 - BOD Power Down in Sleep Enable"]
    #[inline(always)]
    pub fn bodse(&self) -> BODSE_R {
        BODSE_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - BOD Power Down in Sleep"]
    #[inline(always)]
