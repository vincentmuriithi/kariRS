...
#[repr(u8)]
pub enum BOOTSZ_A {
    #[doc = "0: Boot Flash size=4096 words Boot address=$F000"]
    _4096W_F000 = 0,
    #[doc = "1: Boot Flash size=2048 words Boot address=$F800"]
    _2048W_F800 = 1,
    #[doc = "2: Boot Flash size=1024 words Boot address=$FC00"]
    _1024W_FC00 = 2,
    #[doc = "3: Boot Flash size=512 words Boot start address=$FE00"]
    _512W_FE00 = 3,
}
...
impl BOOTSZ_R {
    ...
    pub fn variant(&self) -> BOOTSZ_A {
        match self.bits {
            0 => BOOTSZ_A::_4096W_F000,
            1 => BOOTSZ_A::_2048W_F800,
            2 => BOOTSZ_A::_1024W_FC00,
            3 => BOOTSZ_A::_512W_FE00,
            _ => unreachable!(),
        }
    }
    #[doc = "Checks if the value of the field is `_4096W_F000`"]
    #[inline(always)]
    pub fn is_4096w_f000(&self) -> bool {
        *self == BOOTSZ_A::_4096W_F000
    }
    #[doc = "Checks if the value of the field is `_2048W_F800`"]
    #[inline(always)]
    pub fn is_2048w_f800(&self) -> bool {
        *self == BOOTSZ_A::_2048W_F800
    }
    #[doc = "Checks if the value of the field is `_1024W_FC00`"]
    #[inline(always)]
    pub fn is_1024w_fc00(&self) -> bool {
        *self == BOOTSZ_A::_1024W_FC00
    }
    #[doc = "Checks if the value of the field is `_512W_FE00`"]
    #[inline(always)]
    pub fn is_512w_fe00(&self) -> bool {
        *self == BOOTSZ_A::_512W_FE00
    }
}
...
impl<'a, const O: u8> BOOTSZ_W<'a, O> {
    #[doc = "Boot Flash size=4096 words Boot address=$F000"]
    #[inline(always)]
    pub fn _4096w_f000(self) -> &'a mut W {
        self.variant(BOOTSZ_A::_4096W_F000)
    }
    #[doc = "Boot Flash size=2048 words Boot address=$F800"]
    #[inline(always)]
    pub fn _2048w_f800(self) -> &'a mut W {
        self.variant(BOOTSZ_A::_2048W_F800)
    }
    #[doc = "Boot Flash size=1024 words Boot address=$FC00"]
    #[inline(always)]
    pub fn _1024w_fc00(self) -> &'a mut W {
        self.variant(BOOTSZ_A::_1024W_FC00)
    }
    #[doc = "Boot Flash size=512 words Boot start address=$FE00"]
    #[inline(always)]
    pub fn _512w_fe00(self) -> &'a mut W {
        self.variant(BOOTSZ_A::_512W_FE00)
    }
}
