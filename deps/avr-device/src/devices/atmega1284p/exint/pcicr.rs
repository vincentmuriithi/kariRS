...
pub type PCIE1_R = crate::BitReader<bool>;
#[doc = "Field `PCIE1` writer - Pin Change Interrupt Enable 1"]
pub type PCIE1_W<'a, const O: u8> = crate::BitWriter<'a, u8, PCICR_SPEC, bool, O>;
#[doc = "Field `PCIE2` reader - Pin Change Interrupt Enable 2"]
pub type PCIE2_R = crate::BitReader<bool>;
#[doc = "Field `PCIE2` writer - Pin Change Interrupt Enable 2"]
pub type PCIE2_W<'a, const O: u8> = crate::BitWriter<'a, u8, PCICR_SPEC, bool, O>;
#[doc = "Field `PCIE3` reader - Pin Change Interrupt Enable 3"]
pub type PCIE3_R = crate::BitReader<bool>;
#[doc = "Field `PCIE3` writer - Pin Change Interrupt Enable 3"]
pub type PCIE3_W<'a, const O: u8> = crate::BitWriter<'a, u8, PCICR_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pcie1(&mut self) -> PCIE1_W<1> {
        PCIE1_W::new(self)
    }
    #[doc = "Bit 2 - Pin Change Interrupt Enable 2"]
    #[inline(always)]
    #[must_use]
    pub fn pcie2(&mut self) -> PCIE2_W<2> {
        PCIE2_W::new(self)
    }
    #[doc = "Bit 3 - Pin Change Interrupt Enable 3"]
    #[inline(always)]
    #[must_use]
    pub fn pcie3(&mut self) -> PCIE3_W<3> {
        PCIE3_W::new(self)
    }
