...
pub struct RegisterBlock {
    #[doc = "0x00 - General Timer Conuter Register"]
    pub gtccr: GTCCR,
    #[doc = "0x01 - Output Compare Register B"]
    pub ocr0b: OCR0B,
    _reserved2: [u8; 0x05],
