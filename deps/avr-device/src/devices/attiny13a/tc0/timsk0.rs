...
pub type OCIE0B_W<'a, const O: u8> = crate::BitWriter<'a, u8, TIMSK0_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 2 - Timer/Counter0 Output Compare Match A Interrupt Enable"]
    #[inline(always)]
    pub fn ocie0a(&self) -> OCIE0A_R {
        OCIE0A_R::new(((self.bits >> 2) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ocie0a(&mut self) -> OCIE0A_W<2> {
        OCIE0A_W::new(self)
    }
    #[doc = "Bit 3 - Timer/Counter0 Output Compare Match B Interrupt Enable"]
    #[inline(always)]
