...
pub type WDPH_W<'a, const O: u8> = crate::BitWriter<'a, u8, WDTCR_SPEC, bool, O>;
#[doc = "Field `WDTIE` reader - Watchdog Timeout Interrupt Enable"]
pub type WDTIE_R = crate::BitReader<bool>;
#[doc = "Field `WDTIE` writer - Watchdog Timeout Interrupt Enable"]
pub type WDTIE_W<'a, const O: u8> = crate::BitWriter<'a, u8, WDTCR_SPEC, bool, O>;
#[doc = "Field `WDTIF` reader - Watchdog Timeout Interrupt Flag"]
pub type WDTIF_R = crate::BitReader<bool>;
#[doc = "Field `WDTIF` writer - Watchdog Timeout Interrupt Flag"]
pub type WDTIF_W<'a, const O: u8> = crate::BitWriter<'a, u8, WDTCR_SPEC, bool, O>;
impl R {
    ...
    pub fn wdtie(&self) -> WDTIE_R {
        WDTIE_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - Watchdog Timeout Interrupt Flag"]
    #[inline(always)]
    pub fn wdtif(&self) -> WDTIF_R {
        WDTIF_R::new(((self.bits >> 7) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:2 - Watchdog Timer Prescaler - Low Bits"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn wdtie(&mut self) -> WDTIE_W<6> {
        WDTIE_W::new(self)
    }
    #[doc = "Bit 7 - Watchdog Timeout Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn wdtif(&mut self) -> WDTIF_W<7> {
        WDTIF_W::new(self)
    }
