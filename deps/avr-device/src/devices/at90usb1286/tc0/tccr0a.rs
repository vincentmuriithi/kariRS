...
#[doc = "Field `COM0B` reader - Compare Output Mode, Fast PWm"]
pub type COM0B_R = crate::FieldReader<u8, u8>;
#[doc = "Field `COM0B` writer - Compare Output Mode, Fast PWm"]
pub type COM0B_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, TCCR0A_SPEC, u8, u8, 2, O>;
#[doc = "Field `COM0A` reader - Compare Output Mode, Phase Correct PWM Mode"]
pub type COM0A_R = crate::FieldReader<u8, u8>;
#[doc = "Field `COM0A` writer - Compare Output Mode, Phase Correct PWM Mode"]
...
impl R {
    ...
    #[doc = "Bits 4:5 - Compare Output Mode, Fast PWm"]
    #[inline(always)]
    pub fn com0b(&self) -> COM0B_R {
        COM0B_R::new((self.bits >> 4) & 3)
    }
    #[doc = "Bits 6:7 - Compare Output Mode, Phase Correct PWM Mode"]
    #[inline(always)]
