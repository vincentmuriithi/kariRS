...
impl From<crate::R<XMCRA_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<XMCRA_SPEC>> for W {
    #[inline(always)]
...
pub type SRW0_R = crate::FieldReader<u8, SRW0_A>;
...
pub type SRW0_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, XMCRA_SPEC, u8, SRW0_A, 2, O>;
impl<'a, const O: u8> SRW0_W<'a, O> {
    #[doc = "No wait-states"]
    #[inline(always)]
...
pub type SRW1_R = crate::FieldReader<u8, SRW1_A>;
...
pub type SRW1_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, XMCRA_SPEC, u8, SRW1_A, 2, O>;
...
pub type SRL_R = crate::FieldReader<u8, SRL_A>;
...
pub enum SRL_A {
    ...
    VAL_0X00 = 0,
    #[doc = "1: LS = 0x2100 - 0x1FFF, US = 0x2000 - 0xFFFF"]
    VAL_0X01 = 1,
    #[doc = "2: LS = 0x2100 - 0x3FFF, US = 0x4000 - 0xFFFF"]
    VAL_0X02 = 2,
    #[doc = "3: LS = 0x2100 - 0x5FFF, US = 0x6000 - 0xFFFF"]
    VAL_0X03 = 3,
    #[doc = "4: LS = 0x2100 - 0x7FFF, US = 0x8000 - 0xFFFF"]
    VAL_0X04 = 4,
    #[doc = "5: LS = 0x2100 - 0x9FFF, US = 0xA000 - 0xFFFF"]
    VAL_0X05 = 5,
    #[doc = "6: LS = 0x2100 - 0xBFFF, US = 0xC000 - 0xFFFF"]
    VAL_0X06 = 6,
    #[doc = "7: LS = 0x2100 - 0xDFFF, US = 0xE000 - 0xFFFF"]
    VAL_0X07 = 7,
}
...
pub type SRL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, XMCRA_SPEC, u8, SRL_A, 3, O>;
impl<'a, const O: u8> SRL_W<'a, O> {
    ...
    #[doc = "LS = 0x2100 - 0x1FFF, US = 0x2000 - 0xFFFF"]
    #[inline(always)]
    pub fn val_0x01(self) -> &'a mut W {
        self.variant(SRL_A::VAL_0X01)
    }
    #[doc = "LS = 0x2100 - 0x3FFF, US = 0x4000 - 0xFFFF"]
    #[inline(always)]
    pub fn val_0x02(self) -> &'a mut W {
        self.variant(SRL_A::VAL_0X02)
    }
    #[doc = "LS = 0x2100 - 0x5FFF, US = 0x6000 - 0xFFFF"]
    #[inline(always)]
    pub fn val_0x03(self) -> &'a mut W {
        self.variant(SRL_A::VAL_0X03)
    }
    #[doc = "LS = 0x2100 - 0x7FFF, US = 0x8000 - 0xFFFF"]
    #[inline(always)]
    pub fn val_0x04(self) -> &'a mut W {
        self.variant(SRL_A::VAL_0X04)
    }
    #[doc = "LS = 0x2100 - 0x9FFF, US = 0xA000 - 0xFFFF"]
    #[inline(always)]
    pub fn val_0x05(self) -> &'a mut W {
        self.variant(SRL_A::VAL_0X05)
    }
    #[doc = "LS = 0x2100 - 0xBFFF, US = 0xC000 - 0xFFFF"]
    #[inline(always)]
    pub fn val_0x06(self) -> &'a mut W {
        self.variant(SRL_A::VAL_0X06)
    }
    #[doc = "LS = 0x2100 - 0xDFFF, US = 0xE000 - 0xFFFF"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn srw0(&mut self) -> SRW0_W<0> {
        SRW0_W::new(self)
    }
    #[doc = "Bits 2:3 - Wait state select bit upper page"]
    #[inline(always)]
    #[must_use]
    pub fn srw1(&mut self) -> SRW1_W<2> {
        SRW1_W::new(self)
    }
    #[doc = "Bits 4:6 - Wait state page limit"]
    #[inline(always)]
    #[must_use]
    pub fn srl(&mut self) -> SRL_W<4> {
        SRL_W::new(self)
    }
    #[doc = "Bit 7 - External SRAM Enable"]
    #[inline(always)]
