...
#[doc = "Field `EPRST` reader - No Description."]
pub type EPRST_R = crate::FieldReader<u8, u8>;
#[doc = "Field `EPRST` writer - No Description."]
pub type EPRST_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, UERST_SPEC, u8, u8, 7, O>;
impl R {
    #[doc = "Bits 0:6 - No Description."]
    #[inline(always)]
    pub fn eprst(&self) -> EPRST_R {
        EPRST_R::new(self.bits & 0x7f)
    }
}
impl W {
    #[doc = "Bits 0:6 - No Description."]
