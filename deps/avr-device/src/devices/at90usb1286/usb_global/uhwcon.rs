...
pub type UVCONE_R = crate::BitReader<bool>;
#[doc = "Field `UVCONE` writer - No Description."]
pub type UVCONE_W<'a, const O: u8> = crate::BitWriter<'a, u8, UHWCON_SPEC, bool, O>;
#[doc = "Field `UIDE` reader - No Description."]
pub type UIDE_R = crate::BitReader<bool>;
#[doc = "Field `UIDE` writer - No Description."]
pub type UIDE_W<'a, const O: u8> = crate::BitWriter<'a, u8, UHWCON_SPEC, bool, O>;
#[doc = "Field `UIMOD` reader - No Description."]
pub type UIMOD_R = crate::BitReader<bool>;
#[doc = "Field `UIMOD` writer - No Description."]
pub type UIMOD_W<'a, const O: u8> = crate::BitWriter<'a, u8, UHWCON_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn uvcone(&mut self) -> UVCONE_W<4> {
        UVCONE_W::new(self)
    }
    #[doc = "Bit 6 - No Description."]
    #[inline(always)]
    #[must_use]
    pub fn uide(&mut self) -> UIDE_W<6> {
        UIDE_W::new(self)
    }
    #[doc = "Bit 7 - No Description."]
    #[inline(always)]
    #[must_use]
    pub fn uimod(&mut self) -> UIMOD_W<7> {
        UIMOD_W::new(self)
    }
