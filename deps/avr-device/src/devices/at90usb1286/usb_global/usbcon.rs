...
pub type IDTE_W<'a, const O: u8> = crate::BitWriter<'a, u8, USBCON_SPEC, bool, O>;
...
pub type HOST_W<'a, const O: u8> = crate::BitWriter<'a, u8, USBCON_SPEC, bool, O>;
