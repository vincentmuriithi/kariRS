...
pub struct R(crate::R<USERROW0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USERROW0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USERROW0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USERROW0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USERROW0` writer"]
pub struct W(crate::W<USERROW0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USERROW0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USERROW0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USERROW0_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
