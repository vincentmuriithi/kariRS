...
pub type SEQSEL0_R = crate::FieldReader<u8, SEQSEL0_A>;
...
impl SEQSEL0_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<SEQSEL0_A> {
        match self.bits {
...
pub type SEQSEL0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, SEQCTRL0_SPEC, u8, SEQSEL0_A, 3, O>;
impl<'a, const O: u8> SEQSEL0_W<'a, O> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn seqsel0(&mut self) -> SEQSEL0_W<0> {
        SEQSEL0_W::new(self)
    }
