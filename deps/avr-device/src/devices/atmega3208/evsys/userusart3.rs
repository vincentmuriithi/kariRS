#[doc = "Register `USERUSART3` reader"]
pub struct R(crate::R<USERUSART3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USERUSART3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USERUSART3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USERUSART3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USERUSART3` writer"]
pub struct W(crate::W<USERUSART3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USERUSART3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USERUSART3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USERUSART3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHANNEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, USERUSART3_SPEC, u8, CHANNEL_A, 8, O>;
...
pub struct USERUSART3_SPEC;
impl crate::RegisterSpec for USERUSART3_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [userusart3::R](R) reader structure"]
impl crate::Readable for USERUSART3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [userusart3::W](W) writer structure"]
impl crate::Writable for USERUSART3_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USERUSART3 to value 0"]
impl crate::Resettable for USERUSART3_SPEC {
