#[doc = "Register `CHANNEL5` reader"]
pub struct R(crate::R<CHANNEL5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CHANNEL5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CHANNEL5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CHANNEL5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CHANNEL5` writer"]
pub struct W(crate::W<CHANNEL5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CHANNEL5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CHANNEL5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CHANNEL5_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type GENERATOR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, CHANNEL5_SPEC, u8, GENERATOR_A, 8, O>;
...
pub struct CHANNEL5_SPEC;
impl crate::RegisterSpec for CHANNEL5_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [channel5::R](R) reader structure"]
impl crate::Readable for CHANNEL5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [channel5::W](W) writer structure"]
impl crate::Writable for CHANNEL5_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CHANNEL5 to value 0"]
impl crate::Resettable for CHANNEL5_SPEC {
