...
pub struct R(crate::R<CHANNEL4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CHANNEL4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CHANNEL4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CHANNEL4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CHANNEL4` writer"]
pub struct W(crate::W<CHANNEL4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CHANNEL4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CHANNEL4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CHANNEL4_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type GENERATOR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, CHANNEL4_SPEC, u8, GENERATOR_A, 8, O>;
