#[doc = "Register `CHANNEL6` reader"]
pub struct R(crate::R<CHANNEL6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CHANNEL6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CHANNEL6_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CHANNEL6_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CHANNEL6` writer"]
pub struct W(crate::W<CHANNEL6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CHANNEL6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CHANNEL6_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CHANNEL6_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type GENERATOR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, CHANNEL6_SPEC, u8, GENERATOR_A, 8, O>;
...
pub struct CHANNEL6_SPEC;
impl crate::RegisterSpec for CHANNEL6_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [channel6::R](R) reader structure"]
impl crate::Readable for CHANNEL6_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [channel6::W](W) writer structure"]
impl crate::Writable for CHANNEL6_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CHANNEL6 to value 0"]
impl crate::Resettable for CHANNEL6_SPEC {
