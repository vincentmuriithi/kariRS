#[doc = "Register `USERUSART2` reader"]
pub struct R(crate::R<USERUSART2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USERUSART2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USERUSART2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USERUSART2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USERUSART2` writer"]
pub struct W(crate::W<USERUSART2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USERUSART2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USERUSART2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USERUSART2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHANNEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, USERUSART2_SPEC, u8, CHANNEL_A, 8, O>;
...
pub struct USERUSART2_SPEC;
impl crate::RegisterSpec for USERUSART2_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [userusart2::R](R) reader structure"]
impl crate::Readable for USERUSART2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [userusart2::W](W) writer structure"]
impl crate::Writable for USERUSART2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USERUSART2 to value 0"]
impl crate::Resettable for USERUSART2_SPEC {
