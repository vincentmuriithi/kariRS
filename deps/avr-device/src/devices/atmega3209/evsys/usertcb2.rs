#[doc = "Register `USERTCB2` reader"]
pub struct R(crate::R<USERTCB2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USERTCB2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USERTCB2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USERTCB2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USERTCB2` writer"]
pub struct W(crate::W<USERTCB2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USERTCB2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USERTCB2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USERTCB2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHANNEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, USERTCB2_SPEC, u8, CHANNEL_A, 8, O>;
...
pub struct USERTCB2_SPEC;
impl crate::RegisterSpec for USERTCB2_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [usertcb2::R](R) reader structure"]
impl crate::Readable for USERTCB2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [usertcb2::W](W) writer structure"]
impl crate::Writable for USERTCB2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USERTCB2 to value 0"]
impl crate::Resettable for USERTCB2_SPEC {
