#[doc = "Register `USEREVOUTF` reader"]
pub struct R(crate::R<USEREVOUTF_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USEREVOUTF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USEREVOUTF_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USEREVOUTF_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USEREVOUTF` writer"]
pub struct W(crate::W<USEREVOUTF_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USEREVOUTF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USEREVOUTF_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USEREVOUTF_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHANNEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, USEREVOUTF_SPEC, u8, CHANNEL_A, 8, O>;
...
pub struct USEREVOUTF_SPEC;
impl crate::RegisterSpec for USEREVOUTF_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [userevoutf::R](R) reader structure"]
impl crate::Readable for USEREVOUTF_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [userevoutf::W](W) writer structure"]
impl crate::Writable for USEREVOUTF_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USEREVOUTF to value 0"]
impl crate::Resettable for USEREVOUTF_SPEC {
