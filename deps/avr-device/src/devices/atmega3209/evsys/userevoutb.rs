#[doc = "Register `USEREVOUTB` reader"]
pub struct R(crate::R<USEREVOUTB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USEREVOUTB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USEREVOUTB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USEREVOUTB_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USEREVOUTB` writer"]
pub struct W(crate::W<USEREVOUTB_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USEREVOUTB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USEREVOUTB_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USEREVOUTB_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CHANNEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, USEREVOUTB_SPEC, u8, CHANNEL_A, 8, O>;
...
pub struct USEREVOUTB_SPEC;
impl crate::RegisterSpec for USEREVOUTB_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [userevoutb::R](R) reader structure"]
impl crate::Readable for USEREVOUTB_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [userevoutb::W](W) writer structure"]
impl crate::Writable for USEREVOUTB_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USEREVOUTB to value 0"]
impl crate::Resettable for USEREVOUTB_SPEC {
