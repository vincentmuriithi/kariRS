#[doc = "Register `CHANNEL7` reader"]
pub struct R(crate::R<CHANNEL7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CHANNEL7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CHANNEL7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CHANNEL7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CHANNEL7` writer"]
pub struct W(crate::W<CHANNEL7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CHANNEL7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CHANNEL7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CHANNEL7_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type GENERATOR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, CHANNEL7_SPEC, u8, GENERATOR_A, 8, O>;
...
pub struct CHANNEL7_SPEC;
impl crate::RegisterSpec for CHANNEL7_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [channel7::R](R) reader structure"]
impl crate::Readable for CHANNEL7_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [channel7::W](W) writer structure"]
impl crate::Writable for CHANNEL7_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CHANNEL7 to value 0"]
impl crate::Resettable for CHANNEL7_SPEC {
