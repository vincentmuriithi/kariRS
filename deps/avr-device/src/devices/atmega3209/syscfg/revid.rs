...
pub struct R(crate::R<REVID_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<REVID_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<REVID_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<REVID_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `REVID` writer"]
pub struct W(crate::W<REVID_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<REVID_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<REVID_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<REVID_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
