...
pub struct R(crate::R<USERROW37_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USERROW37_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USERROW37_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USERROW37_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USERROW37` writer"]
pub struct W(crate::W<USERROW37_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USERROW37_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USERROW37_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USERROW37_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
