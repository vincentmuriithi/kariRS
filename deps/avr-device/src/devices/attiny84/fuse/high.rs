...
#[doc = "Field `RSTDISBL` reader - Reset Disabled (Enable PB3 as i/o pin)"]
pub type RSTDISBL_R = crate::BitReader<bool>;
#[doc = "Field `RSTDISBL` writer - Reset Disabled (Enable PB3 as i/o pin)"]
...
impl R {
    ...
    #[doc = "Bit 7 - Reset Disabled (Enable PB3 as i/o pin)"]
    #[inline(always)]
