...
pub enum SUT_CKSEL_A {
    ...
    #[doc = "34: Int. RC Osc. 8 MHz; Start-up time PWRDWN/RESET: 6 CK/14 CK + 64 ms; default value"]
    INTRCOSC_8MHZ_6CK_14CK_64MS_DEFAULT = 34,
...
impl SUT_CKSEL_R {
    ...
    pub fn variant(&self) -> Option<SUT_CKSEL_A> {
        match self.bits {
            ...
            34 => Some(SUT_CKSEL_A::INTRCOSC_8MHZ_6CK_14CK_64MS_DEFAULT),
    ...
    #[doc = "Checks if the value of the field is `INTRCOSC_8MHZ_6CK_14CK_64MS_DEFAULT`"]
    #[inline(always)]
    pub fn is_intrcosc_8mhz_6ck_14ck_64ms_default(&self) -> bool {
        *self == SUT_CKSEL_A::INTRCOSC_8MHZ_6CK_14CK_64MS_DEFAULT
    }
...
impl<'a, const O: u8> SUT_CKSEL_W<'a, O> {
    ...
    #[doc = "Int. RC Osc. 8 MHz; Start-up time PWRDWN/RESET: 6 CK/14 CK + 64 ms; default value"]
    #[inline(always)]
    pub fn intrcosc_8mhz_6ck_14ck_64ms_default(self) -> &'a mut W {
        self.variant(SUT_CKSEL_A::INTRCOSC_8MHZ_6CK_14CK_64MS_DEFAULT)
    }
...
#[doc = "Field `CKOUT` reader - Clock output on PORTB2"]
pub type CKOUT_R = crate::BitReader<bool>;
#[doc = "Field `CKOUT` writer - Clock output on PORTB2"]
...
impl R {
    ...
    #[doc = "Bit 6 - Clock output on PORTB2"]
    #[inline(always)]
