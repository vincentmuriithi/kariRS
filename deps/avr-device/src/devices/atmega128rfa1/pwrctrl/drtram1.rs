...
pub struct R(crate::R<DRTRAM1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DRTRAM1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DRTRAM1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DRTRAM1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DRTRAM1` writer"]
pub struct W(crate::W<DRTRAM1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DRTRAM1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DRTRAM1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DRTRAM1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ENDRT_W<'a, const O: u8> = crate::BitWriter<'a, u8, DRTRAM1_SPEC, bool, O>;
#[doc = "Field `DRTSWOK` reader - DRT Switch OK"]
pub type DRTSWOK_R = crate::BitReader<bool>;
#[doc = "Field `DRTSWOK` writer - DRT Switch OK"]
pub type DRTSWOK_W<'a, const O: u8> = crate::BitWriter<'a, u8, DRTRAM1_SPEC, bool, O>;
#[doc = "Field `Res` reader - Reserved"]
pub type RES_R = crate::FieldReader<u8, u8>;
#[doc = "Field `Res` writer - Reserved"]
pub type RES_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, DRTRAM1_SPEC, u8, u8, 2, O>;
impl R {
