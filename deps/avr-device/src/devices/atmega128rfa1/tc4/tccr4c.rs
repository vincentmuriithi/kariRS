...
pub type RES_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, TCCR4C_SPEC, u8, u8, 5, O>;
#[doc = "Field `FOC4C` reader - Force Output Compare for Channel C"]
pub type FOC4C_R = crate::BitReader<bool>;
...
pub type FOC4B_R = crate::BitReader<bool>;
...
pub type FOC4A_R = crate::BitReader<bool>;
