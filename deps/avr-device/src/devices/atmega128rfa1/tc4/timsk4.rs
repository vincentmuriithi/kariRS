...
#[doc = "Field `OCIE4C` reader - Timer/Counter4 Output Compare C Match Interrupt Enable"]
pub type OCIE4C_R = crate::BitReader<bool>;
#[doc = "Field `OCIE4C` writer - Timer/Counter4 Output Compare C Match Interrupt Enable"]
pub type OCIE4C_W<'a, const O: u8> = crate::BitWriter<'a, u8, TIMSK4_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 1 - Timer/Counter4 Output Compare A Match Interrupt Enable"]
    #[inline(always)]
    pub fn ocie4a(&self) -> OCIE4A_R {
        OCIE4A_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Timer/Counter4 Output Compare B Match Interrupt Enable"]
    #[inline(always)]
    pub fn ocie4b(&self) -> OCIE4B_R {
        OCIE4B_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Timer/Counter4 Output Compare C Match Interrupt Enable"]
    #[inline(always)]
    pub fn ocie4c(&self) -> OCIE4C_R {
        OCIE4C_R::new(((self.bits >> 3) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ocie4c(&mut self) -> OCIE4C_W<3> {
        OCIE4C_W::new(self)
    }
    #[doc = "Bit 5 - Timer/Counter4 Input Capture Interrupt Enable"]
    #[inline(always)]
