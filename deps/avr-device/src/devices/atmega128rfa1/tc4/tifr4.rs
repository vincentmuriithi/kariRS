...
#[doc = "Field `OCF4A` reader - Timer/Counter4 Output Compare A Match Flag"]
pub type OCF4A_R = crate::BitReader<bool>;
#[doc = "Field `OCF4A` writer - Timer/Counter4 Output Compare A Match Flag"]
pub type OCF4A_W<'a, const O: u8> = crate::BitWriter<'a, u8, TIFR4_SPEC, bool, O>;
#[doc = "Field `OCF4B` reader - Timer/Counter4 Output Compare B Match Flag"]
pub type OCF4B_R = crate::BitReader<bool>;
#[doc = "Field `OCF4B` writer - Timer/Counter4 Output Compare B Match Flag"]
pub type OCF4B_W<'a, const O: u8> = crate::BitWriter<'a, u8, TIFR4_SPEC, bool, O>;
#[doc = "Field `OCF4C` reader - Timer/Counter4 Output Compare C Match Flag"]
pub type OCF4C_R = crate::BitReader<bool>;
#[doc = "Field `OCF4C` writer - Timer/Counter4 Output Compare C Match Flag"]
...
impl R {
    ...
    #[doc = "Bit 1 - Timer/Counter4 Output Compare A Match Flag"]
    #[inline(always)]
    pub fn ocf4a(&self) -> OCF4A_R {
        OCF4A_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Timer/Counter4 Output Compare B Match Flag"]
    #[inline(always)]
    pub fn ocf4b(&self) -> OCF4B_R {
        OCF4B_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Timer/Counter4 Output Compare C Match Flag"]
    #[inline(always)]
