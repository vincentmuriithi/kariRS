...
pub type ISC4_R = crate::FieldReader<u8, ISC4_A>;
...
pub type ISC4_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, EICRB_SPEC, u8, ISC4_A, 2, O>;
...
pub type ISC5_R = crate::FieldReader<u8, ISC5_A>;
...
pub type ISC5_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, EICRB_SPEC, u8, ISC5_A, 2, O>;
impl<'a, const O: u8> ISC5_W<'a, O> {
    #[doc = "The low level of INTn generates an interrupt request."]
    #[inline(always)]
    pub fn the_low_level_of_intn_generates_an_interrupt_request(self) -> &'a mut W {
...
pub type ISC6_R = crate::FieldReader<u8, ISC6_A>;
...
pub type ISC6_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, EICRB_SPEC, u8, ISC6_A, 2, O>;
impl<'a, const O: u8> ISC6_W<'a, O> {
    #[doc = "The low level of INTn generates an interrupt request."]
    #[inline(always)]
    pub fn the_low_level_of_intn_generates_an_interrupt_request(self) -> &'a mut W {
...
pub type ISC7_R = crate::FieldReader<u8, ISC7_A>;
...
pub type ISC7_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, EICRB_SPEC, u8, ISC7_A, 2, O>;
