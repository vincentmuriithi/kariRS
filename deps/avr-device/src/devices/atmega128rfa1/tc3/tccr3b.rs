...
impl CS3_R {
    ...
    #[doc = "Checks if the value of the field is `EXTERNAL_CLOCK_SOURCE_ON_TN_PIN_CLOCK_ON_FALLING_EDGE`"]
    #[inline(always)]
    ...
    #[doc = "Checks if the value of the field is `EXTERNAL_CLOCK_SOURCE_ON_TN_PIN_CLOCK_ON_RISING_EDGE`"]
    #[inline(always)]
...
impl<'a, const O: u8> CS3_W<'a, O> {
    ...
    #[inline(always)]
    pub fn external_clock_source_on_tn_pin_clock_on_falling_edge(self) -> &'a mut W {
    ...
    #[inline(always)]
    pub fn external_clock_source_on_tn_pin_clock_on_rising_edge(self) -> &'a mut W {
...
pub type WGM3_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, TCCR3B_SPEC, u8, WGM3_A, 2, O>;
...
pub type RES_W<'a, const O: u8> = crate::BitWriter<'a, u8, TCCR3B_SPEC, bool, O>;
