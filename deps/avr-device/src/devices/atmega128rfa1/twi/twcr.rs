...
pub type RES_W<'a, const O: u8> = crate::BitWriter<'a, u8, TWCR_SPEC, bool, O>;
...
#[doc = "Field `TWWC` reader - TWI Write Collision Flag"]
...
impl R {
    ...
    #[doc = "Bit 1 - Reserved Bit"]
    #[inline(always)]
    pub fn res(&self) -> RES_R {
        RES_R::new(((self.bits >> 1) & 1) != 0)
    }
    ...
    #[doc = "Bit 3 - TWI Write Collision Flag"]
    #[inline(always)]
