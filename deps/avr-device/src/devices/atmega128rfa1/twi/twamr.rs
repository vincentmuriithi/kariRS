...
pub type RES_W<'a, const O: u8> = crate::BitWriter<'a, u8, TWAMR_SPEC, bool, O>;
#[doc = "Field `TWAM` reader - TWI (Slave) Address Mask Bits"]
pub type TWAM_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TWAM` writer - TWI (Slave) Address Mask Bits"]
pub type TWAM_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, TWAMR_SPEC, u8, u8, 7, O>;
impl R {
