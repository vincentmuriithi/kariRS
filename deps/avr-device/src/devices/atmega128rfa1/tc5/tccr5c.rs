...
pub type RES_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, TCCR5C_SPEC, u8, u8, 5, O>;
#[doc = "Field `FOC5C` reader - Force Output Compare for Channel C"]
pub type FOC5C_R = crate::BitReader<bool>;
...
pub type FOC5B_R = crate::BitReader<bool>;
...
pub type FOC5A_R = crate::BitReader<bool>;
