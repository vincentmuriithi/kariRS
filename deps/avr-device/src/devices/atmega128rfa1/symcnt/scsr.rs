...
pub type SCBSY_R = crate::BitReader<bool>;
#[doc = "Field `SCBSY` writer - Symbol Counter busy"]
pub type SCBSY_W<'a, const O: u8> = crate::BitWriter<'a, u8, SCSR_SPEC, bool, O>;
#[doc = "Field `Res` reader - Reserved Bit"]
pub type RES_R = crate::FieldReader<u8, u8>;
#[doc = "Field `Res` writer - Reserved Bit"]
pub type RES_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, SCSR_SPEC, u8, u8, 7, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn scbsy(&mut self) -> SCBSY_W<0> {
        SCBSY_W::new(self)
    }
    #[doc = "Bits 1:7 - Reserved Bit"]
    #[inline(always)]
