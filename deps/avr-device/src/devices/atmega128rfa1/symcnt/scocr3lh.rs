...
pub struct R(crate::R<SCOCR3LH_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SCOCR3LH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SCOCR3LH_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SCOCR3LH_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SCOCR3LH` writer"]
pub struct W(crate::W<SCOCR3LH_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SCOCR3LH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SCOCR3LH_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SCOCR3LH_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SCOCR3LH` reader - Symbol Counter Output Compare Register 3 LH-Byte"]
pub type SCOCR3LH_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SCOCR3LH` writer - Symbol Counter Output Compare Register 3 LH-Byte"]
pub type SCOCR3LH_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, SCOCR3LH_SPEC, u8, u8, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn scocr3lh(&mut self) -> SCOCR3LH_W<0> {
        SCOCR3LH_W::new(self)
    }
