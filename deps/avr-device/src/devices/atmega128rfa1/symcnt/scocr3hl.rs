...
pub struct R(crate::R<SCOCR3HL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SCOCR3HL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SCOCR3HL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SCOCR3HL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SCOCR3HL` writer"]
pub struct W(crate::W<SCOCR3HL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SCOCR3HL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SCOCR3HL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SCOCR3HL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SCOCR3HL` reader - Symbol Counter Output Compare Register 3 HL-Byte"]
pub type SCOCR3HL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SCOCR3HL` writer - Symbol Counter Output Compare Register 3 HL-Byte"]
pub type SCOCR3HL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, SCOCR3HL_SPEC, u8, u8, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn scocr3hl(&mut self) -> SCOCR3HL_W<0> {
        SCOCR3HL_W::new(self)
    }
