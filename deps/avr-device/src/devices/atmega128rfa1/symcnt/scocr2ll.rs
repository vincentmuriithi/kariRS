...
pub struct R(crate::R<SCOCR2LL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SCOCR2LL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SCOCR2LL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SCOCR2LL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SCOCR2LL` writer"]
pub struct W(crate::W<SCOCR2LL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SCOCR2LL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SCOCR2LL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SCOCR2LL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SCOCR2LL` reader - Symbol Counter Output Compare Register 2 LL-Byte"]
pub type SCOCR2LL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SCOCR2LL` writer - Symbol Counter Output Compare Register 2 LL-Byte"]
pub type SCOCR2LL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, SCOCR2LL_SPEC, u8, u8, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn scocr2ll(&mut self) -> SCOCR2LL_W<0> {
        SCOCR2LL_W::new(self)
    }
