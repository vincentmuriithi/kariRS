...
pub struct R(crate::R<SCOCR3HH_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SCOCR3HH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SCOCR3HH_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SCOCR3HH_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SCOCR3HH` writer"]
pub struct W(crate::W<SCOCR3HH_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SCOCR3HH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SCOCR3HH_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SCOCR3HH_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SCOCR3HH` reader - Symbol Counter Output Compare Register 3 HH-Byte"]
pub type SCOCR3HH_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SCOCR3HH` writer - Symbol Counter Output Compare Register 3 HH-Byte"]
pub type SCOCR3HH_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, SCOCR3HH_SPEC, u8, u8, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn scocr3hh(&mut self) -> SCOCR3HH_W<0> {
        SCOCR3HH_W::new(self)
    }
