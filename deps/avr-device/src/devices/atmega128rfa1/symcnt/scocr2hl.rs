...
pub struct R(crate::R<SCOCR2HL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SCOCR2HL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SCOCR2HL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SCOCR2HL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SCOCR2HL` writer"]
pub struct W(crate::W<SCOCR2HL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SCOCR2HL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SCOCR2HL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SCOCR2HL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SCOCR2HL` reader - Symbol Counter Output Compare Register 2 HL-Byte"]
pub type SCOCR2HL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SCOCR2HL` writer - Symbol Counter Output Compare Register 2 HL-Byte"]
pub type SCOCR2HL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, SCOCR2HL_SPEC, u8, u8, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn scocr2hl(&mut self) -> SCOCR2HL_W<0> {
        SCOCR2HL_W::new(self)
    }
