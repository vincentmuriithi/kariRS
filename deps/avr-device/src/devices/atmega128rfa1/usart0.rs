...
pub struct RegisterBlock {
    #[doc = "0x00 - USART0 Control and Status Register A"]
    pub ucsr0a: UCSR0A,
    #[doc = "0x01 - USART0 Control and Status Register B"]
    pub ucsr0b: UCSR0B,
    #[doc = "0x02 - USART0 Control and Status Register C"]
    pub ucsr0c: UCSR0C,
    _reserved3: [u8; 0x01],
    #[doc = "0x04 - USART0 Baud Rate Register Bytes"]
    pub ubrr0: UBRR0,
    #[doc = "0x06 - USART0 I/O Data Register"]
    pub udr0: UDR0,
}
...
#[doc = "USART0 Control and Status Register C"]
pub mod ucsr0c;
