...
pub type PRSPI_W<'a, const O: u8> = crate::BitWriter<'a, u8, PRR0_SPEC, bool, O>;
...
#[doc = "Field `PRPGA` reader - Power Reduction PGA"]
pub type PRPGA_R = crate::BitReader<bool>;
#[doc = "Field `PRPGA` writer - Power Reduction PGA"]
pub type PRPGA_W<'a, const O: u8> = crate::BitWriter<'a, u8, PRR0_SPEC, bool, O>;
...
pub type PRTWI_W<'a, const O: u8> = crate::BitWriter<'a, u8, PRR0_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 4 - Power Reduction PGA"]
    #[inline(always)]
    pub fn prpga(&self) -> PRPGA_R {
        PRPGA_R::new(((self.bits >> 4) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn prpga(&mut self) -> PRPGA_W<4> {
        PRPGA_W::new(self)
    }
    #[doc = "Bit 5 - Power Reduction Timer/Counter0"]
    #[inline(always)]
