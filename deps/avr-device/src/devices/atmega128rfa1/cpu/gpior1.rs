...
#[doc = "Field `GPIOR` reader - General Purpose I/O Register 1 Value"]
pub type GPIOR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `GPIOR` writer - General Purpose I/O Register 1 Value"]
pub type GPIOR_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, GPIOR1_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - General Purpose I/O Register 1 Value"]
    #[inline(always)]
