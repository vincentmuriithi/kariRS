...
pub enum RAMPZ_A {
    ...
    DEFAULT_VALUE_OF_Z_POINTER_MSB_S = 0,
}
...
impl RAMPZ_R {
    ...
    pub fn variant(&self) -> Option<RAMPZ_A> {
        match self.bits {
            0 => Some(RAMPZ_A::DEFAULT_VALUE_OF_Z_POINTER_MSB_S),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `DEFAULT_VALUE_OF_Z_POINTER_MSB_S`"]
    #[inline(always)]
    pub fn is_default_value_of_z_pointer_msb_s(&self) -> bool {
        *self == RAMPZ_A::DEFAULT_VALUE_OF_Z_POINTER_MSB_S
    }
}
...
impl<'a, const O: u8> RAMPZ_W<'a, O> {
    ...
    #[inline(always)]
    pub fn default_value_of_z_pointer_msb_s(self) -> &'a mut W {
        self.variant(RAMPZ_A::DEFAULT_VALUE_OF_Z_POINTER_MSB_S)
    }
}
