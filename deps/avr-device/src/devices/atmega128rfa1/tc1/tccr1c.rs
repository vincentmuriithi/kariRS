...
pub type RES_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, TCCR1C_SPEC, u8, u8, 5, O>;
#[doc = "Field `FOC1C` reader - Force Output Compare for Channel C"]
pub type FOC1C_R = crate::BitReader<bool>;
#[doc = "Field `FOC1C` writer - Force Output Compare for Channel C"]
pub type FOC1C_W<'a, const O: u8> = crate::BitWriter<'a, u8, TCCR1C_SPEC, bool, O>;
#[doc = "Field `FOC1B` reader - Force Output Compare for Channel B"]
...
#[doc = "Field `FOC1A` reader - Force Output Compare for Channel A"]
