...
impl CPHA_R {
    ...
    #[doc = "Checks if the value of the field is `SAMPLE_LEADING_EDGE_SETUP_TRAILING_EDGE`"]
    #[inline(always)]
    pub fn is_sample_leading_edge_setup_trailing_edge(&self) -> bool {
        *self == CPHA_A::SAMPLE_LEADING_EDGE_SETUP_TRAILING_EDGE
    }
    #[doc = "Checks if the value of the field is `SETUP_LEADING_EDGE_SAMPLE_TRAILING_EDGE`"]
    #[inline(always)]
...
pub type CPHA_W<'a, const O: u8> = crate::BitWriter<'a, u8, SPCR_SPEC, CPHA_A, O>;
impl<'a, const O: u8> CPHA_W<'a, O> {
    #[doc = "Sample (Leading Edge), Setup (Trailing Edge)"]
    #[inline(always)]
    pub fn sample_leading_edge_setup_trailing_edge(self) -> &'a mut W {
        self.variant(CPHA_A::SAMPLE_LEADING_EDGE_SETUP_TRAILING_EDGE)
    }
    #[doc = "Setup (Leading Edge), Sample (Trailing Edge)"]
    #[inline(always)]
    pub fn setup_leading_edge_sample_trailing_edge(self) -> &'a mut W {
...
impl CPOL_R {
    ...
    #[doc = "Checks if the value of the field is `RISING_LEADING_EDGE_FALLING_TRAILING_EDGE`"]
    #[inline(always)]
    pub fn is_rising_leading_edge_falling_trailing_edge(&self) -> bool {
        *self == CPOL_A::RISING_LEADING_EDGE_FALLING_TRAILING_EDGE
    }
    #[doc = "Checks if the value of the field is `FALLING_LEADING_EGDE_RISING_TRAILING_EDGE`"]
    #[inline(always)]
...
pub type CPOL_W<'a, const O: u8> = crate::BitWriter<'a, u8, SPCR_SPEC, CPOL_A, O>;
impl<'a, const O: u8> CPOL_W<'a, O> {
    #[doc = "Rising (Leading Edge), Falling (Trailing Edge)"]
    #[inline(always)]
    pub fn rising_leading_edge_falling_trailing_edge(self) -> &'a mut W {
        self.variant(CPOL_A::RISING_LEADING_EDGE_FALLING_TRAILING_EDGE)
    }
    #[doc = "Falling (Leading Egde), Rising (Trailing Edge)"]
    #[inline(always)]
    pub fn falling_leading_egde_rising_trailing_edge(self) -> &'a mut W {
