...
pub type CHANNEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, PHY_CC_CCA_SPEC, u8, CHANNEL_A, 5, O>;
...
pub type CCA_MODE_R = crate::FieldReader<u8, CCA_MODE_A>;
...
pub type CCA_MODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u8, PHY_CC_CCA_SPEC, u8, CCA_MODE_A, 2, O>;
impl<'a, const O: u8> CCA_MODE_W<'a, O> {
...
pub type CCA_REQUEST_R = crate::BitReader<bool>;
#[doc = "Field `CCA_REQUEST` writer - Manual CCA Measurement Request"]
pub type CCA_REQUEST_W<'a, const O: u8> = crate::BitWriter<'a, u8, PHY_CC_CCA_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cca_mode(&mut self) -> CCA_MODE_W<5> {
        CCA_MODE_W::new(self)
    }
    #[doc = "Bit 7 - Manual CCA Measurement Request"]
    #[inline(always)]
    #[must_use]
    pub fn cca_request(&mut self) -> CCA_REQUEST_W<7> {
        CCA_REQUEST_W::new(self)
    }
