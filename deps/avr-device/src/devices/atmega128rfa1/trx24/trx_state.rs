...
pub type TRX_CMD_R = crate::FieldReader<u8, TRX_CMD_A>;
...
pub type TRX_CMD_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, TRX_STATE_SPEC, u8, TRX_CMD_A, 5, O>;
impl<'a, const O: u8> TRX_CMD_W<'a, O> {
    #[doc = "NOP"]
    #[inline(always)]
...
pub type TRAC_STATUS_R = crate::FieldReader<u8, TRAC_STATUS_A>;
...
pub type TRAC_STATUS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, TRX_STATE_SPEC, u8, TRAC_STATUS_A, 3, O>;
impl<'a, const O: u8> TRAC_STATUS_W<'a, O> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn trx_cmd(&mut self) -> TRX_CMD_W<0> {
        TRX_CMD_W::new(self)
    }
    #[doc = "Bits 5:7 - Transaction Status"]
    #[inline(always)]
    #[must_use]
    pub fn trac_status(&mut self) -> TRAC_STATUS_W<5> {
        TRAC_STATUS_W::new(self)
    }
