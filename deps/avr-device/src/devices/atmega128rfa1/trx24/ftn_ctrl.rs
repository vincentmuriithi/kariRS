...
pub type FTN_START_R = crate::BitReader<bool>;
#[doc = "Field `FTN_START` writer - Start Calibration Loop of Filter Tuning Network"]
pub type FTN_START_W<'a, const O: u8> = crate::BitWriter<'a, u8, FTN_CTRL_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ftn_start(&mut self) -> FTN_START_W<7> {
        FTN_START_W::new(self)
    }
