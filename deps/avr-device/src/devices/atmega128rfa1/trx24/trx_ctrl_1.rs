...
pub type RES_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, TRX_CTRL_1_SPEC, u8, u8, 5, O>;
#[doc = "Field `TX_AUTO_CRC_ON` reader - Enable Automatic CRC Calculation"]
pub type TX_AUTO_CRC_ON_R = crate::BitReader<bool>;
#[doc = "Field `TX_AUTO_CRC_ON` writer - Enable Automatic CRC Calculation"]
pub type TX_AUTO_CRC_ON_W<'a, const O: u8> = crate::BitWriter<'a, u8, TRX_CTRL_1_SPEC, bool, O>;
#[doc = "Field `IRQ_2_EXT_EN` reader - Connect Frame Start IRQ to TC1"]
pub type IRQ_2_EXT_EN_R = crate::BitReader<bool>;
#[doc = "Field `IRQ_2_EXT_EN` writer - Connect Frame Start IRQ to TC1"]
pub type IRQ_2_EXT_EN_W<'a, const O: u8> = crate::BitWriter<'a, u8, TRX_CTRL_1_SPEC, bool, O>;
#[doc = "Field `PA_EXT_EN` reader - External PA support enable"]
pub type PA_EXT_EN_R = crate::BitReader<bool>;
#[doc = "Field `PA_EXT_EN` writer - External PA support enable"]
pub type PA_EXT_EN_W<'a, const O: u8> = crate::BitWriter<'a, u8, TRX_CTRL_1_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tx_auto_crc_on(&mut self) -> TX_AUTO_CRC_ON_W<5> {
        TX_AUTO_CRC_ON_W::new(self)
    }
    #[doc = "Bit 6 - Connect Frame Start IRQ to TC1"]
    #[inline(always)]
    #[must_use]
    pub fn irq_2_ext_en(&mut self) -> IRQ_2_EXT_EN_W<6> {
        IRQ_2_EXT_EN_W::new(self)
    }
    #[doc = "Bit 7 - External PA support enable"]
    #[inline(always)]
    #[must_use]
    pub fn pa_ext_en(&mut self) -> PA_EXT_EN_W<7> {
        PA_EXT_EN_W::new(self)
    }
