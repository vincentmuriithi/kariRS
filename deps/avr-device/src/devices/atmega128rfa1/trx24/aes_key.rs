...
pub type AES_KEY_R = crate::FieldReader<u8, u8>;
#[doc = "Field `AES_KEY` writer - AES Encryption/Decryption Key Buffer"]
pub type AES_KEY_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, AES_KEY_SPEC, u8, u8, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aes_key(&mut self) -> AES_KEY_W<0> {
        AES_KEY_W::new(self)
    }
