...
pub struct R(crate::R<IEEE_ADDR_1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IEEE_ADDR_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<IEEE_ADDR_1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<IEEE_ADDR_1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `IEEE_ADDR_1` writer"]
pub struct W(crate::W<IEEE_ADDR_1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<IEEE_ADDR_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<IEEE_ADDR_1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<IEEE_ADDR_1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type IEEE_ADDR__W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u8, IEEE_ADDR_1_SPEC, u8, u8, 8, O>;
impl R {
