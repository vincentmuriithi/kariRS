...
pub type PSRASY_R = crate::BitReader<bool>;
#[doc = "Field `PSRASY` writer - Prescaler Reset Timer/Counter2"]
pub type PSRASY_W<'a, const O: u8> = crate::BitWriter<'a, u8, GTCCR_SPEC, bool, O>;
#[doc = "Field `Res` reader - Reserved"]
pub type RES_R = crate::FieldReader<u8, u8>;
#[doc = "Field `Res` writer - Reserved"]
pub type RES_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, GTCCR_SPEC, u8, u8, 5, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn psrasy(&mut self) -> PSRASY_W<1> {
        PSRASY_W::new(self)
    }
    #[doc = "Bits 2:6 - Reserved"]
    #[inline(always)]
