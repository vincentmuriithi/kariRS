...
impl CS0_R {
    ...
    #[doc = "Checks if the value of the field is `NO_CLOCK_SOURCE_TIMER_COUNTER0_STOPPED`"]
    #[inline(always)]
    ...
    #[doc = "Checks if the value of the field is `EXTERNAL_CLOCK_SOURCE_ON_T0_PIN_CLOCK_ON_FALLING_EDGE`"]
    #[inline(always)]
    ...
    #[doc = "Checks if the value of the field is `EXTERNAL_CLOCK_SOURCE_ON_T0_PIN_CLOCK_ON_RISING_EDGE`"]
    #[inline(always)]
...
impl<'a, const O: u8> CS0_W<'a, O> {
    ...
    #[inline(always)]
    pub fn no_clock_source_timer_counter0_stopped(self) -> &'a mut W {
    ...
    #[inline(always)]
    pub fn external_clock_source_on_t0_pin_clock_on_falling_edge(self) -> &'a mut W {
    ...
    #[inline(always)]
    pub fn external_clock_source_on_t0_pin_clock_on_rising_edge(self) -> &'a mut W {
...
pub type RES_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, TCCR0B_SPEC, u8, u8, 2, O>;
