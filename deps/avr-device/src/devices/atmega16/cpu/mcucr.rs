...
impl SM_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<SM_A> {
        match self.bits {
            0 => Some(SM_A::IDLE),
            1 => Some(SM_A::ADC),
            2 => Some(SM_A::PDOWN),
            3 => Some(SM_A::PSAVE),
            8 => Some(SM_A::VAL_0X04),
            9 => Some(SM_A::VAL_0X05),
            10 => Some(SM_A::STDBY),
            11 => Some(SM_A::ESTDBY),
            _ => None,
        }
...
pub type SM_W<'a, const O: u8> = crate::FieldWriter<'a, u8, MCUCR_SPEC, u8, SM_A, 4, O>;
...
impl R {
    ...
    #[doc = "Bits 4:7 - Sleep Mode Select"]
    #[inline(always)]
    pub fn sm(&self) -> SM_R {
        SM_R::new((self.bits >> 4) & 0x0f)
    }
    #[doc = "Bit 6 - Sleep Enable"]
    #[inline(always)]
    pub fn se(&self) -> SE_R {
        SE_R::new(((self.bits >> 6) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:1 - Interrupt Sense Control 0 Bits"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn sm(&mut self) -> SM_W<4> {
        SM_W::new(self)
    }
    #[doc = "Bit 6 - Sleep Enable"]
    #[inline(always)]
    #[must_use]
    pub fn se(&mut self) -> SE_W<6> {
        SE_W::new(self)
    }
