...
#[doc = "Field `PSR10` reader - Prescaler reset"]
pub type PSR10_R = crate::BitReader<bool>;
#[doc = "Field `PSR10` writer - Prescaler reset"]
pub type PSR10_W<'a, const O: u8> = crate::BitWriter<'a, u8, SFIOR_SPEC, bool, O>;
#[doc = "Field `PSR2` reader - Prescaler reset"]
pub type PSR2_R = crate::BitReader<bool>;
#[doc = "Field `PSR2` writer - Prescaler reset"]
...
impl R {
    #[doc = "Bit 0 - Prescaler reset"]
    #[inline(always)]
    pub fn psr10(&self) -> PSR10_R {
        PSR10_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Prescaler reset"]
    #[inline(always)]
