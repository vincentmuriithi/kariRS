...
pub type OCIE0_R = crate::BitReader<bool>;
#[doc = "Field `OCIE0` writer - Timer/Counter0 Output Compare Match Interrupt register"]
pub type OCIE0_W<'a, const O: u8> = crate::BitWriter<'a, u8, TIMSK_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ocie0(&mut self) -> OCIE0_W<1> {
        OCIE0_W::new(self)
    }
