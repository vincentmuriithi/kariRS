...
pub enum CS_A {
    ...
    #[doc = "5: Running, CLK/1024"]
    PRESCALE_1024 = 5,
    #[doc = "6: Running, ExtClk T1 Falling Edge"]
    EXT_FALLING = 6,
    #[doc = "7: Running, ExtClk T1 Rising Edge"]
    EXT_RISING = 7,
}
...
impl CS_R {
    ...
    pub fn is_ext_falling(&self) -> bool {
        *self == CS_A::EXT_FALLING
    }
    #[doc = "Checks if the value of the field is `EXT_RISING`"]
    #[inline(always)]
    pub fn is_ext_rising(&self) -> bool {
        *self == CS_A::EXT_RISING
    }
}
#[doc = "Field `CS` writer - Clock Select"]
pub type CS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, TCCR1B_SPEC, u8, CS_A, 3, O>;
impl<'a, const O: u8> CS_W<'a, O> {
    ...
    #[doc = "Running, ExtClk T1 Falling Edge"]
    #[inline(always)]
    pub fn ext_falling(self) -> &'a mut W {
        self.variant(CS_A::EXT_FALLING)
    }
    #[doc = "Running, ExtClk T1 Rising Edge"]
    #[inline(always)]
    pub fn ext_rising(self) -> &'a mut W {
        self.variant(CS_A::EXT_RISING)
    }
}
