...
pub struct R(crate::R<USIPP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USIPP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USIPP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USIPP_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USIPP` writer"]
pub struct W(crate::W<USIPP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USIPP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USIPP_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USIPP_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
