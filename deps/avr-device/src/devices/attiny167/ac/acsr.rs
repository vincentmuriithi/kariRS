...
#[doc = "Field `ACIRS` reader - Analog Comparator Internal Reference Select"]
pub type ACIRS_R = crate::BitReader<bool>;
#[doc = "Field `ACIRS` writer - Analog Comparator Internal Reference Select"]
pub type ACIRS_W<'a, const O: u8> = crate::BitWriter<'a, u8, ACSR_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 6 - Analog Comparator Internal Reference Select"]
    #[inline(always)]
    pub fn acirs(&self) -> ACIRS_R {
        ACIRS_R::new(((self.bits >> 6) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn acirs(&mut self) -> ACIRS_W<6> {
        ACIRS_W::new(self)
    }
    #[doc = "Bit 7 - Analog Comparator Disable"]
    #[inline(always)]
