...
impl MUX_R {
    ...
    #[doc = "Checks if the value of the field is `ADC_AVCC_4`"]
    #[inline(always)]
...
impl<'a, const O: u8> MUX_W<'a, O> {
    ...
    #[doc = "AVcc/4"]
    #[inline(always)]
    pub fn adc_avcc_4(self) -> &'a mut W {
...
impl REFS_R {
    ...
    #[doc = "Checks if the value of the field is `INTERNAL_11`"]
    #[inline(always)]
    pub fn is_internal_11(&self) -> bool {
        *self == REFS_A::INTERNAL_11
    }
    #[doc = "Checks if the value of the field is `INTERNAL_256`"]
    #[inline(always)]
