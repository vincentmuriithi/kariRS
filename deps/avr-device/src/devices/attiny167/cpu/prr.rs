...
#[doc = "Field `PRUSI` reader - Power Reduction USI"]
pub type PRUSI_R = crate::BitReader<bool>;
#[doc = "Field `PRUSI` writer - Power Reduction USI"]
...
#[doc = "Field `PRLIN` reader - Power Reduction LINUART"]
pub type PRLIN_R = crate::BitReader<bool>;
#[doc = "Field `PRLIN` writer - Power Reduction LINUART"]
pub type PRLIN_W<'a, const O: u8> = crate::BitWriter<'a, u8, PRR_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 1 - Power Reduction USI"]
    #[inline(always)]
    pub fn prusi(&self) -> PRUSI_R {
        PRUSI_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Power Reduction Timer/Counter0"]
    #[inline(always)]
    pub fn prtim0(&self) -> PRTIM0_R {
        PRTIM0_R::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    #[doc = "Bit 4 - Power Reduction SPI"]
    #[inline(always)]
    pub fn prspi(&self) -> PRSPI_R {
        PRSPI_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - Power Reduction LINUART"]
    #[inline(always)]
    pub fn prlin(&self) -> PRLIN_R {
        PRLIN_R::new(((self.bits >> 5) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Power Reduction ADC"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn prtim0(&mut self) -> PRTIM0_W<2> {
        PRTIM0_W::new(self)
    }
    #[doc = "Bit 3 - Power Reduction Timer/Counter1"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn prspi(&mut self) -> PRSPI_W<4> {
        PRSPI_W::new(self)
    }
    #[doc = "Bit 5 - Power Reduction LINUART"]
    #[inline(always)]
    #[must_use]
    pub fn prlin(&mut self) -> PRLIN_W<5> {
        PRLIN_W::new(self)
    }
