...
#[doc = "Field `PSR1` reader - Prescaler Reset Synchronous 16-bit Timer/Counter1"]
pub type PSR1_R = crate::BitReader<bool>;
#[doc = "Field `PSR1` writer - Prescaler Reset Synchronous 16-bit Timer/Counter1"]
pub type PSR1_W<'a, const O: u8> = crate::BitWriter<'a, u8, GTCCR_SPEC, bool, O>;
#[doc = "Field `PSR0` reader - Prescaler Reset Asynchronous 8-bit Timer/Counter0"]
pub type PSR0_R = crate::BitReader<bool>;
#[doc = "Field `PSR0` writer - Prescaler Reset Asynchronous 8-bit Timer/Counter0"]
pub type PSR0_W<'a, const O: u8> = crate::BitWriter<'a, u8, GTCCR_SPEC, bool, O>;
...
impl R {
    #[doc = "Bit 0 - Prescaler Reset Synchronous 16-bit Timer/Counter1"]
    #[inline(always)]
    pub fn psr1(&self) -> PSR1_R {
        PSR1_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Prescaler Reset Asynchronous 8-bit Timer/Counter0"]
    #[inline(always)]
