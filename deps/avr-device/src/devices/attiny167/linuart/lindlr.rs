...
pub type LRXDL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LRXDL` writer - LIN Receive Data Length bits"]
pub type LRXDL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, LINDLR_SPEC, u8, u8, 4, O>;
#[doc = "Field `LTXDL` reader - LIN Transmit Data Length bits"]
pub type LTXDL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LTXDL` writer - LIN Transmit Data Length bits"]
pub type LTXDL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, LINDLR_SPEC, u8, u8, 4, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lrxdl(&mut self) -> LRXDL_W<0> {
        LRXDL_W::new(self)
    }
    #[doc = "Bits 4:7 - LIN Transmit Data Length bits"]
    #[inline(always)]
    #[must_use]
    pub fn ltxdl(&mut self) -> LTXDL_W<4> {
        LTXDL_W::new(self)
    }
