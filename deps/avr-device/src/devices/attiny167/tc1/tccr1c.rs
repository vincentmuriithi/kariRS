...
#[doc = "Field `FOC1B` writer - Timer/Counter1 Force Output Compare for Channel B"]
pub type FOC1B_W<'a, const O: u8> = crate::BitWriter<'a, u8, TCCR1C_SPEC, bool, O>;
#[doc = "Field `FOC1A` writer - Timer/Counter1 Force Output Compare for Channel A"]
pub type FOC1A_W<'a, const O: u8> = crate::BitWriter<'a, u8, TCCR1C_SPEC, bool, O>;
impl W {
    #[doc = "Bit 6 - Timer/Counter1 Force Output Compare for Channel B"]
    #[inline(always)]
    #[must_use]
    pub fn foc1b(&mut self) -> FOC1B_W<6> {
        FOC1B_W::new(self)
    }
    #[doc = "Bit 7 - Timer/Counter1 Force Output Compare for Channel A"]
    #[inline(always)]
    #[must_use]
