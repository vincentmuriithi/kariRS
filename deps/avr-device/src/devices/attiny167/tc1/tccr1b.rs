...
#[doc = "Field `CS1` reader - Timer/Counter1 Clock Select bits"]
pub type CS1_R = crate::FieldReader<u8, CS1_A>;
#[doc = "Timer/Counter1 Clock Select bits\n\nValue on reset: 0"]
...
#[doc = "Field `CS1` writer - Timer/Counter1 Clock Select bits"]
...
impl R {
    #[doc = "Bits 0:2 - Timer/Counter1 Clock Select bits"]
    #[inline(always)]
