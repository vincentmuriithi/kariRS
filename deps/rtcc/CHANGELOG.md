...
### Added
- Add optional `defmt` feature implementing `defmt::Format` on some types.
...
<!-- next-url -->
[Unreleased]: https://github.com/eldruin/rtcc-rs/compare/v0.4.0...HEAD
[0.4.0]: https://github.com/eldruin/rtcc-rs/compare/v0.3.2...v0.4.0
